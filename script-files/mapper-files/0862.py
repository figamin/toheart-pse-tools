...
text_array = [
    ...
    ("ボールの福方に高注目してたから、戟レミィが薰矢をつがえるとこｂを見てなかったが、３本を一瞬で冾放つなんて≠普通できないだｂう。",
    ""),
    ...
    ""),
    # ...The more I remember it, it felt so amazing.

    ("「って艪ゆうか、天才じ痰ゃねえのか？」",
    ""),
    # "Is that so, is that a genius, that's a phlegm?"

    ("「そお？」",
    ""),
    # "Ah?"

    ("「戟レミィが出齒ればどんな蛯大痩煢も優泓勝するんじ痰ゃねえのか？」†",
    ""),
    # "If you get the Remy, any big-skinned dog will win, so is there no phlegm?"

    ("「ありがとう、。…それがね、アタシ、止まってる的、うまく狙えないのｃ」",
    ""),
    # "Thank you... But I'm not really trying to aim properly, because it's stopped."

    ("「それって、的が止まってると最燕初のときみたく地面に突き刺さるってことか？」",
    ""),
    # "Does that mean that when the target stops, it sticks to the ground, like when it was the first time in the first place?"
    ...
    ("結論として、弓道の蛯大痩には撃レミィの実力が発揮できる墲種目はなく、いつ烽も竄補√欠なんだそうだ。",
    ""),
