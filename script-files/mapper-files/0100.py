...
text_array = [
    ("（あかり	冝日付イベント１）閨（３獅月１３冾日）閨（好感度が１以繹上のとき）閨（昼休み）閨（教室	休み桙時間	♂史	＝普通）†",
    ""),
    # (Akari Pick Date Event 1) Pick (3 Lion Days 13th Days) Pick (When the likelihood level is above 1) Pick (Lunch break) Pick (Classic holiday time ♂ history = normal)†
    ...
    ("いつ烽もどおり購ロ買粕部でモ買ったパンとコーヒーの汲昼£メシを食い終え、♂史とふたりでだべっていると。†",
    ""),
    ...
    ("「ううん、こっちこそ楽しかったって伝えて。おかげでｉ史ち痰ゃんのｊ咽竃魔煬ｩ鼬れたし」†",
    ""),
    ...
    ("「うん。だから、明坙日に備えて最終チェックっていうか。おたがい墲わかんないとこを確認し№合ったりして」†",
    ""),
