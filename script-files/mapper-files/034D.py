...
# Source file: 034D.txt

text_array = [
    ("（智子	好感度イベント４回目）閨（選択綜Ｂの続き）",
    ""),
    ...
    ("あのことがあってから、委員長にはなんとなく声をかけづらい。",
    ""),
    # After that, it's somehow difficult to talk to the chairman.

    ("こんなふうに避けてばっかりだと、おたがいどんどん溝が深くなるってことも、わかっち痰ゃいるんだが。",
    ""),
    # If you keep avoiding them like this, you'll find that the trench will deepen and deepen.

    ("それでも、つい、なんとなく、またの機級に譲っちまうんだよなぁ…。◯",
    ""),
    # So I guess I'll just give it to another model...◯
