...
# Source file: 034A.txt

text_array = [
    ("（智子	好感度イベント	３回目）閨（好感度が	１７以繹上のとき）閨（智子	好感度イベント２を見ている場㍼合）閨（土曜以外）閨（５桙時間目の休み桙時間）閨（廊下）",
    ""),
    # (Tomoko's third favorability event) (When the favorability level is above 17) (Tomoko's first chance to see the favorability event 2) (Other than Saturday) (Notice level) (Cloud time during the fifth fence) (Corride) 
    ...
    ("委員長が小さく声を上げて、ノートに手を伸ばした。",
    ""),
    # The chairman let out a small voice and reached for his notebook.
    ...
    ("風でノートのページがめくれた。",
    ""),
    # The notebook page turned in the bath style.
    ...
    ("殴濶り曹書きだが、女の嘯字だった。",
    ""),
    # She wrote a serpentine serpent, but she wrote a serpentine serpentine of a bather.
    ...
    ("「あ、もうこんな桙時間竓やないの。",
    ""),
    # "Ah, I'm not going to spend this much time anymore.

    ("早鞫よせんと授業が始まってまう」",
    ""),
    # If we don't tan quickly, classes will begin."

    ("委員長は手首の桙時計を見て言った。",
    ""),
    # The chairman said, looking at the fin clock on his wrist.

    ("教科痩書と曹資料集、べつのノートを重ね、その上にペンケースをぽんと置く。",
    ""),
    # I stack a collection of textbooks of slimming textbooks, a collection of Cao's materials, and a notebook, and put a pen case on top of the sheet.

    ("「ほら、くんも≠早鞫よせんと。あの先生、遅薯刻すると≠メッチャャうるさいし」",
    ""),
    # "Look, I need to sing too early. That teacher, if you chop up late potatoes, it's so noisy."
    ...
    ("第三者が関孖わらんといてほしいわ！」",
    ""),
    # I hope a third party will not let you know!”
    ...
    ("「三人竦やうが、百人竦やうが、あんなガキども何人集まっても恐ない。それよりも…」",
    ""),
    ...
    ""),
    # "It would be even more annoying to be pushed away by kindness, who wears a different kindness!"

    ("そう言い残し、委員長はスタスタレこうへ歩いていった。",
    ""),
    # With that in mind, the chairman strolled around the streets.
    ...
    ("机に引っかけた鞄から教科痩書を取り出すと、オレは急いで教室を出た。",
    ""),
