...
text_array = [
    ...
    ("真んｒに鳥薯居の印。",
    ""),
    # The symbol of the potato porridge is in the middle.

    ("それをはさむ『はい』と『いいえ』の文囎字。",
    ""),
    ...
    ("「いま動かしてるの、諱先輩じ痰ゃないの？」",
    ""),
    # "Are you moving now, Senpai, are you phlegmless?"
    ...
    ("「え？	質竡問？」",
    ""),
    # "Huh? A question about the quality?"
    ...
    ("п割闃りばしの動きが止まった。",
    ""),
    # The movement of the пにない has stopped.
    ...
    ("諱先輩の頬が、ますます赤くなった。◯",
    ""),
    # Senpai's cheeks became redder and redder.◯
