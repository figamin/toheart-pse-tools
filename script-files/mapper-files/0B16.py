...
text_array = [
    ...
    ("「あっ、最近、釣闥りが好き！」",
    ""),
    # "Ah, I've been fond of fishing lately!"
    ...
    ""),
    # In the end, the day was late and the game continued to go on a long way from Aya∴Ka's "This is the hot spot for fishing!"I was told ".

    ("別れたのは、夕菶方の６桙時ぐらいだった。◯",
    ""),
    # We parted ways at Yuzunakata's six-frame time.◯
