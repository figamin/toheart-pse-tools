...
text_array = [
    ...
    ("１面は２箇渇所で赤ショットに切關り換える以外は青ショットで進みます。",
    ""),
    ...
    ("以繹上のポイントを守齊れば、１面クリアで３３００怩万点以繹上出ます。この桙時点でオールクリア档時のスコアが志保を上回驩るのは間違いありません。",
    ""),
    ...
    ("しかしタイミングが異常にシビアで、人間業では安闊定は不可能に思えます。",
    ""),
    ...
    ("ボスの「戦艦ミレニアム」では砲莓台からの弾をひたすらイチゴにしてスコアを稼ぎます。",
    ""),
    ...
    ("緑耐性の雑寰魚が多いので、緑ショットを反射させて他の雑寰魚を倒し、１０倍ボーナスを狙います。",
    ""),
    ...
    ("『彼女』が出た後は、ミスしてもかまわないので、残っているボムを有効に使って下さい。◯",
    ""),
