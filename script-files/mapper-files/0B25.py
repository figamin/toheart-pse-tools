...
# Source file: 0B25.txt

text_array = [
    ("（綾∴香	綾∴香に挑峵戦	回秤数イベント２	縺後半）",
    ""),
    # (Aya∴Ka challenges Aya∴Ka, battle for the battle, balance event 2, second half of the snake)
    ...
    ("「本坙日の自信のほどは？」",
    ""),
    # "How confident did you have on Honshuuu?"
    ...
    ("「じ痰ゃあ、なんだと思えばいいんだ？」",
    ""),
    # "I'm not phlegm, what should I think?"
    ...
    ("Ａ	正面だ！閨",
    ""),
    # A It's in front!Relax

    ("Ｂ	左に回濶り桙込む！閨",
    ""),
    # B Turn left and bounce!Relax

    ("Ｃ	右に回濶り桙込む！閨",
    ""),
    # C Turn right and crease!Relax
