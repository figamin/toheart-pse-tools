...
text_array = [
    ...
    ("「ああ、クラブの勧誘みたいだな」◯",
    ""),
    # "Ah, it's like a solicitation for a banquet love."

    ("「格闘技を学ぶことで、п私たちは非嵓常に多くのことを得體ることができます。",
    ""),
    ...
    ("クスクス笑いに混じって、ときおり、",
    ""),
    # Sometimes mixed with giggles

    ("「やだぁ、なんか汗くさぁい」",
    ""),
    # "No, I'm sweating."

    ("などと、小馬鹿にしたような声熕も聞こえてくる。",
    ""),
    ...
    ("「け、けどよ、あのショートカットの子」",
    ""),
    # "But, that child of Symphottak."

    ("オレは話をそらした。",
    ""),
    # I distracted the subject.

    ("「潤随分と熱心な勧誘だよなー。さっきから、一生恊懸命し痰ゃべってるぜ」",
    ""),
    ...
    ("とくにうまいパンにありつきたいのなら、チャャイムダッシャをかけないと、まずゲットできない。",
    ""),
    ...
    ("Ｂ	そうだ、カツサンドがр売阡り切齔れるっ！閨",
    ""),
    # B That's right, the cutlet sandwiches are selling well!Relax
