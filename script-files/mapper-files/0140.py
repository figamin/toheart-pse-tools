...
text_array = [
    ...
    ("「＊淫俣凬pンだと、飽きてこない？」",
    ""),
    # "*If you're in the inmata stomp, don't you get bored of it?"

    ("「まーな。けど、学食＄メニャーのほうが食い飽きちまったからな」",
    ""),
    # "Well, though. But I'm tired of eating more at the school cafeteria."
    ...
    ("別れ際の廊下で、念を押すようにあかりが言った。◯",
    ""),
    # Akari said in the hallway to part ways.◯
