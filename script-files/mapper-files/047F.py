...
text_array = [
    ...
    ("「まぁ〜ずは、志保ち痰ゃんから行くね！」",
    ""),
    # "Well, I'll go, Shiho's sphin-yan!"
    ...
    ("マイクを通したままで志保が言う。",
    ""),
    # Shiho says while he keeps the microphone in place.
    ...
    ("志保の選んだ曲は…、◯",
    ""),
    # Shiho's song choice is...

    ("「あっ『ＦＥＥＬＩＮＧ	ＨＥＡＲＴ』だ」",
    ""),
    # "Ah, it's 'FEELING HEART'."

    ("志保め、さっそく新枢芋浮}スターしてきたな…。",
    ""),
    ...
    ("「あなたと、出初ってぇ、こ〜いにおちぃた」",
    ""),
    # "I'm going to start a new year with you, so I'm so happy."
    ...
    ""),
    # If you're too good like Shiho, you can even get deducted.
    ...
    ("「分ったぁ！	裏技諡よ！	あんたみたいに歌えば、良い点が取齊れるのね！？」",
    ""),
    # "I understand! A secret trick! If you sing like you, you can get good points, right?!"
