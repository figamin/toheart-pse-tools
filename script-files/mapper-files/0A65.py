...
text_array = [
    ...
    ("「で烽も、頭がいいとか悪いとかじ痰ゃなくて、少しずつで烽も、氏落ちｒいて揩理解するかどうかだと思うぜ。まずは、苦闍手っていう先嵩観を取っ払ってだな｢｢」",
    ""),
    ...
    ("「この調子だったら、きっといつ烽もよりいい点が取齊れると思うよ」",
    ""),
    ...
    ("そして揩理女緒ち痰ゃんは、氈次の職齔場へと元気に魔走っていった。",
    ""),
