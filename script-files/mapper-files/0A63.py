...
# Source file: 0A63.txt

text_array = [
    ("「п私、今厓日燗もバイトがあるから。",
    ""),
    # "I currently have a part-time job at Kohinkan.

    ("次のまでにけっこう桙時間があるから、勉強してるの」",
    ""),
    # I have quite a bit of time before the next one, so I'm studying."

    ("「バイト？	テスト凬期間樺くらい、休んだらどうなんだ？」",
    ""),
