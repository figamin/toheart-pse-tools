...
text_array = [
    ...
    ("「あ〜ったりまえよ。はじめのジャャンケンに勝つの烽も勝縁負のうちなんだから」†",
    ""),
    ...
    ("そう言いつつ烽も、『♂史を狙っち痰ゃえ』と目で",
    ""),
    # With that in mind, Kao also said, "Aiming for the history of the ♂, sighs."
