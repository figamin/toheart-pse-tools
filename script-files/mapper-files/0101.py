...
text_array = [
    ...
    ""),
    # "Ah, I'm coming back to Chishonan's house now, and I'll come directly to Chishonan's house."
    ...
    ("「ち痰ゃんと家にいてね」",
    ""),
    # "Look at home with a sphin's sphin'."
    ...
    ("「ふたりの№仲をジャャマしち痰ゃ悪いと思って」",
    ""),
    # "I thought it would be bad if the two were to get along with each other."

    ("「くだんねー気をつかうな」",
    ""),
    # "Damn, don't take care."
