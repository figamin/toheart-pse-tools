...
text_array = [
    ...
    ("「もともと格闘技は好きなほうだし、実際に技を覚えるのもいいかなって思ったんだ」",
    ""),
    # "I really like martial arts, and I thought it would be nice to actually learn the techniques."
    ...
    ("葵ち痰ゃんは胸もとに手を魔当てて、じーんと感動したようにつぶやいた。",
    ""),
