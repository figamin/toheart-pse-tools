...
text_array = [
    ...
    ("学年又末テスト最終叝日。",
    ""),
    # The final day of the grade and final exams.

    ("いよいよ今厓日で終尞わりだな。",
    ""),
    # It's finally time for the day to end.
    ...
    ("「いい点、諱取齊れそう？」",
    ""),
    # "Good points, can you get a name for yourself?"
    ...
    ("Ｂ	まあまあ、だな。閨",
    ""),
    # B: Well, that's right.Relax

    ("Ｃ	全然ダ＜メ。閨",
    ""),
    # C It's completely bad.Relax

    ("Ａ	まあまあ、だな。閨",
    ""),
    # A: Well, that's right.Relax

    ("Ｂ	全然ダ＜メ。閨",
    ""),
    # B It's completely bad.Relax
