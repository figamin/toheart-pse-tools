...
text_array = [
    ...
    ("「でも、まわりのみんなは≠普通の格好してるでしょ？	п私だけ浮いてて、恥ずかしくて、あんまり外には出たくなかったな」",
    ""),
    ...
    ("秩白酒に撃酔ったオレが、あかりんちのひな壇に上って、それをぶっつぶした｢｢とまあ、そんな内容だ。",
    ""),
    ...
    ("「お前の記憶力だよ。そんな何年熹も前の話をいつまでも覚えてるんだからな」",
    ""),
