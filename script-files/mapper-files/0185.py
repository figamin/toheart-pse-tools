...
text_array = [
    ...
    ("「うちの親なんか晴齔れｒのお前見骭るたびに、浴女の子が欲しい、浴女の子が欲しいって言ってたからな。記憶にｍ闕り桙込まれちまったぜ」†",
    ""),
    ...
    ("「で烽も、覚えてるって聞いたのは、そのことじ痰ゃないよ。ひな壇蜥大崩壊哩事庶件のこと」",
    ""),
    # "And I heard that you remember that, you can't help but feel that. It's about the sudden collapse of the world."
    ...
    ("没菇収しようとしたが、うまくごまかされて逃げられた。◯",
    ""),
    # He tried to conceal him, but he was successfully deceived and escaped.◯
