...
# Source file: 0120.txt

text_array = [
    ("（あかり	ＶＳイベント	智子）閨（二年になった以降）閨（あかり好感度２５以繹上	智子好感度１５以繹上）閨（５桙時間目の休み桙時間）閨（２Ｆ廊下）",
    ""),
    # (Akari VS Event Tomoko) (After the second year) (Akari likeability level 25 or higher, Tomoko likeability level 15 or higher) (Akari likeability level 5 or higher) (Cloud time on the 2nd floor corridor) (2nd floor corridor) 
    ...
    ("「おっ、なんだ、めずらしーな、そっちから声かけてくるなんて」",
    ""),
    # "Oh, what? That's so rare, you're calling out to me over there."

    ("軽い口調で切關り出したのに、委員長はいつもの淡々とした調子で返してきた。",
    ""),
    ...
    ("「あのよ、いちおう言っておくけど、オレはべつに、あかりといつもいっしょにいるわけじ痰ゃないんだぞ」",
    ""),
    ...
    ("否阡定するつもりで言いかけた言葉だったが、その瞬間、ちょっとした疑站問が頭に浮かび、オレは続きを飲み桙込んでしまった。",
    ""),
    ...
    ("やっぱりオレとあかりって、おたがいそんなつもりじ痰ゃないにせよ、他人から見鼬ればつき№合ってるように見えてるわけだ。",
    ""),
    ...
    ("そう考えると、うーむ…。",
    ""),
    # When I think about it that way, hmm...
    ...
    ("Ａ	はっきりと否阡定した。閨",
    ""),
    # A: It was clearly denied.Relax

    ("Ｂ	とくに否阡定しなかった。閨",
    ""),
    # B: It was not particularly denied.Relax
