...
text_array = [
    ...
    ("１階に降闕りてくると、ａモップを手に廊下を掃恆除する翌女生徒がいた。",
    ""),
    ...
    ("息を切逅らせながら、ゴシゴシ床をこすっている。",
    ""),
    # He scrubs the floor, breathing through the air.

    ("香ロボットとはいえ、一生恊懸命真面目に掃恆除してる姿は、端から見てて烽も気搴持ちがいい。†",
    ""),
    ...
    ("お手伝い高ロボットなんだから、はなっからそんなふうにｍ迯られていて烽も魔当たり前か。†",
    ""),
    # Since he is a high-spirited robot, he is always on the verge of mischief and it's only natural that he is a demon.†
    ...
    ("「はいっ、ありがとうございます。みなさんにｊ闃",
    ""),
    # "Yes, thank you. I'm sorry to all of you.

    ("んでいただけるよう、諱頑張ってピカピカにみがきます！」",
    ""),
    # I'll do my best to brush my teeth so that you can do it!”
