...
text_array = [
    ...
    ("「今厓日は部賦はないのか？」",
    ""),
    # "Is there no partial fees for the day now?"

    ("「夕菶方からだよ」",
    ""),
    # "It's from the Yuuu"

    ("「そうか、ご苦労なこったな。だけどそれにしち痰ゃ、ずいぶんと≠早い桙時間じ痰ゃないか？」",
    ""),
