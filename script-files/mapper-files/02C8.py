...
# Source file: 02C8.txt

text_array = [
    ("（芹°香	回秤数イベント	２Ｆ	ＬＶ６）閨（諱画面揺逞らし）",
    ""),
    # (Seri°Kawaii Scale Number Event 2F LV6)Seri (Screen Screen Shake)
    ...
    ("「えっ？	また部室にｗて欲しいって？」",
    ""),
    # "Huh? You want me to go to the club room again?"
