...
text_array = [
    ...
    ("それからいよいよ製錐開始だ。",
    ""),
    # Then it's finally time for the cone to be made.
    ...
    ""),
    # "Huh? Please make me look like my senior's M-Senru?"
    ...
    ("まず皮を３№枚重ね、くるくると巻いて腕にする。",
    ""),
    # First, stack three layers of leather, then roll it around to make your arms.

    ("２№枚重ねた皮で皮のくずをくるんで、頭をｍ骰る。",
    ""),
    ...
    ("あとはｎで宸縛髞る。",
    ""),
    # All that's left is to tie it down with n.
    ...
    ("「え？	これで№仲良くなれんの？」",
    ""),
    # "Huh? Can you become friends with No. 1 with this?"
