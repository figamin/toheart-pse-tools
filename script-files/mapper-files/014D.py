...
text_array = [
    ...
    ("「ま、まあ、諱取闔りあえず話だけ聞いてみて、それでどうするかは自分でｌめてくれ。じ痰ゃ、﨟矢⊥島のрヤツを呼んでくるから｢｢」",
    ""),
    # "Well, well, just listen to the story and then give yourself what you'll do. I'll call the guy on 﨟Aya⊥ Island, so "
    ...
    ("ほんの数秒の重齒苦しい沈黙。",
    ""),
    # A painful silence for just a few seconds.
