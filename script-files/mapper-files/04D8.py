...
text_array = [
    ...
    ("「だからな、どうしてみんながそう思うのかが不思議なんだよ」",
    ""),
    # "That's why it's strange why people think that way."

    ("「そう見えるからじ痰ゃないかな」",
    ""),
    # "I think it looks like that, so I guess there's no phlegm."
