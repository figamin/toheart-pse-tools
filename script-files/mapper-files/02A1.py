...
text_array = [
    ...
    ("冝放課繪後のｒ鋳で、ひとり読蒼書か。",
    ""),
    # After the school is finished, I wrote a solo reading and writing in the r-casting casting.
    ...
    ("「諱よっ、なに読んでんの？」",
    ""),
    # "My name is, what are you reading?"

    ("たずねると、諱先輩は、ぱた…と本を閉じて、表侮を見せてくれた。",
    ""),
    ...
    ("「諱よく、ここで本とか読んでんの？」",
    ""),
    # "Do you know, do you read books here?"
    ...
    ""),
    # "Whoa. I'm not gonna get slurp, I'll be greeted lol. I'm gonna kill the time here like this?"
