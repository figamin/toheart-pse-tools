...
text_array = [
    ...
    ("土曜坥日ってのは、なんとなく得した気分になれる冾日だ。",
    ""),
    # Saturday Day is a day that makes you feel like you've somehow gotten a good deal.

    ("明坙日が冾日曜坥日だと思うと、なおさらだ。",
    ""),
    ...
    ("明坙日起きるのがつらそうだぜ。◯",
    ""),
    # It would be tough to wake up Ming Shun.◯
