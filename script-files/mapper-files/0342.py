...
text_array = [
    ("（智子	好感度イベント１回目）閨（選択綜Ｂ	委員長に写させて烽もらう。の続き）閨（授業拠２）†",
    ""),
    ...
    ("まるで、最燕初から墲わかっている嘯答えをただ曹書き写しているかのようだ。†",
    ""),
    ...
    ("こ、こり痰ゃとて烽も『いいよ』なんて言葉が返ってきそうな雰囲気じ痰ゃねーな。",
    ""),
    ...
    ("こうなったら信叶頼度には№欠けるが、あかりかｉ史にで烽も写させて烽もらうとしよう。",
    ""),
    ...
    ("それにして烽も、なんだ、委員長って、結構熏もの墲わかりいいрヤツじ痰ゃん。",
    ""),
