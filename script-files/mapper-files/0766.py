...
text_array = [
    ...
    ("もう、そこにいた全員が大囁爆笑だ。あれはオレも恥ずかしかった！」",
    ""),
    ...
    ("この、時緕代を一周してブレイクしそうな、懐かしい撃レト鴻ロギャャグ！",
    ""),
    ...
    ("「あの、これは『開くの１０桙時か』と『悪の十囂字架』をかけたダジャャレなんスけど」",
    ""),
    ...
    ("「諱よーし、まだまだいくぜ、ネタ麻当てクイズ諠第３問。｢｢って、なんじ痰ゃそのネーミングは！」",
    ""),
