...
# Source file: 0347.txt

text_array = [
    ("（智子	好感度イベント１回目）閨（二回目の選択綜）閨（選択綜Ｂ	寝髏る派	の続き）",
    ""),
    # (Tomoko's first favorability event) (Second time) (Second time) (Continued with Selection B: The Sleeping Fantasy) 

    ("寝髏る派だ。",
    ""),
    # I'm the type to sleep.

    ("春の陽気はとにかく眠気を誘う。",
    ""),
    # The cheerfulness of spring is just drowsy.

    ("おまけに窓のр隙間からは心地いい春の翌風が流齬れ桙込んできて、そよそよと頬をなでていく。",
    ""),
    ...
    ("机の上に両腕を組んで、轣顔をうずめて寝髏る。",
    ""),
    # He folded his arms over the desk, leaned his face and stomped his back.

    ("教室はザ純ワザ純ワうるさいが、こういうざわめきは、意外と気にならないもんだ。",
    ""),
    ...
    ("諱よく、赤ち痰ゃんは母親の心汾臓の音を聞くと落ちｒくという話を耳にするが、小薯ｒ高校と聞き慣れたざわめきも一種それと翌似たような効果があるのかも知れない。",
    ""),
    ...
    ("蛛大きなあくびがこぼれ、だんだんウトウトし始めた。",
    ""),
    # A big yawn spilled out, and gradually began to doze.
