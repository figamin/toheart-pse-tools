...
text_array = [
    ...
    ("声をかけると、諱先輩はこっちに気づいた。",
    ""),
    # When I called out to him, Senpai I realized this.
    ...
    ("ドアが開き、そのｒから現鼬れたのは…。",
    ""),
    # The door opened and it appeared from the r...
    ...
    ""),
    # "Oh, maybe it was your sister's boyfriend #? Wow, that's just a coincidence."
    ...
    ("そう言って現鼬れたのは、諱先輩に奄負けず劣逞らずのｔ人の翌女の子だった。",
    ""),
    ...
    ""),
    # "Oh? Sister, is he #Mr. on the day you're in the middle of your day? Wow, that's rare!"
    ...
    ("Ａ	全然卵似てねーな。閨",
    ""),
    # A It doesn't look like an egg at all.Relax
