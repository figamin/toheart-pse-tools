...
text_array = [
    ...
    ("「良いチャャンスだと思って、少しのあいだ休んじまうってのはどーだ？」",
    ""),
    # "What do you think it's a good chahance and take a break for a while?"
    ...
    ("「あ、また始まるみたい。じ痰ゃ、行ってくるね」",
    ""),
    # "Oh, it looks like it's going to start again. I'll go."
