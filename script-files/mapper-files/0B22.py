...
text_array = [
    ...
    ""),
    # "It's fine to use your legs, but if you're going to try to revive it, it's better to use the opposite, right?

    ("相闡手の前足の外側に回濶り桙込むのは薰基本譁よ」",
    ""),
    # It is the basic way to turn around outside the fore legs of the related hand."
