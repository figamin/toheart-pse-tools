...
text_array = [
    ...
    ("洋棊服屋の前で志保を見かけた。",
    ""),
    # I saw Shiho in front of a Western-style suit shop.
    ...
    ("意表を突かれた様子で、志保がこっちに振關りｌく。",
    ""),
    # Shiho seemed to be surprised, and he called out to me.

    ("呼んだのがオ激レだと気づくと、",
    ""),
    # When I realized that I was calling him,

    ("「あっ、じ痰ゃん」",
    ""),
    # "Ah, sputum."

    ("竅やたら嬉しそうな顔をしてｋけ寄ってきた。†",
    ""),
    ...
    ("「ち蛯ょーどいいとこｂにｗた墲わね。あんた、いま、ヒマ？」",
    ""),
    # "You're the best place to b. You're free now?"

    ("「ま、ヒマだからここにいるんだけどな」",
    ""),
    # "Well, I'm here because I've had time."

    ("「んじ痰ゃ、今から遊びに行こっ」",
    ""),
    # "Not really phlegm, let's go and play now."

    ("そう言ってぐいぐいオ激レの腕を引っ張髓る。†",
    ""),
    ...
    ("「まあまあ、今厓日は一梭時休寀戦ってことでさ」",
    ""),
    # "Well, I'm going to have to go to a holiday on the day."

    ("言いながら、志保は店燗内に入っていった。",
    ""),
    # As he said, Shiho entered the store's hot water.

    ("「怪しい…」",
    ""),
    # "suspicious…"

    ("そう思いながら烽も、オ激レは志保のあとを追った。†",
    ""),
    ...
    ("制梵服藍女子ｎ高生が、でっかいハムスターだかうさぎだとかと墲戦う、内容が意味不明のアクシ㏍ョンゲーム。",
    ""),
    ...
    ("＝普段は対岺戦ばかり競っているだけに、二人用を竄やｂうって言い出すとこｂが怪しい。",
    ""),
    # =Since we usually only compete against each other, it's suspicious that b begins to say that we should tamper with two people or b.
    ...
    ("「しびれるって言うか、即死するんだよな」",
    ""),
    # "I mean I'm numb, I'm going to die instantly."

    ("「なによう、人聞きの悪い」",
    ""),
    # "What, people are not listening to it"

    ("「実際、死ぬだｂ」",
    ""),
    # "In fact, I'm going to die."
    ...
    ("「っとに、文蝠句ばっか言ってないで選ぶの」",
    ""),
    # "I'll just choose without saying only sentences."

    ("「だったらオ激レは『ソア宴ラおｏ様』」",
    ""),
    # "If that's the case, I'll be "Soarbant Rao-sama."

    ("お手軽で強力なキャャ宴ラといったら、竅やっぱ彼濫女だｂう。†",
    ""),
    ...
    ("「なに言ってんだ？	オ激レはな、生き残骼る道を選んだだけだ。おめえこそ、自分に翌似てるからって繧弱いキャャ宴ラ選ぶなよ」†",
    ""),
    ...
    ("磨当然のことながら、バ潟リアがあるのと無いのとでは安心感が痰違う。",
    ""),
    ...
    ("＃保につつかれ、ソア宴ラは目を回した。",
    ""),
    # #Sorry, Soaranra turned his eyes.
    ...
    ("しかしｔ保の手に入齠れたのはパ純ワーダウン。",
    ""),
    # However, what T-Ho was able to get a boost.
    ...
    ("４面、５面とさすがに冾日頃のバト泣ルの成果があら墲われるのか、足を引っ張闥り№合いながら烽も№順調に突破するオ激レたち。",
    ""),
    ...
    ("「イエ〜イ…じ痰ゃなかった。",
    ""),
    # "Yeah... I had no phlegm.

    ("大苟丈夫か！？」",
    ""),
    # Is it sturdy??”

    ("「蛛大苟丈夫じ痰ゃない墲わよ！	死人に福口無しよ！」",
    ""),
    ...
    ("この頃には、面が始まったと同椏時におたがいを気站絶させようと、ポジシ㏍ョンの奪い№合いだ。",
    ""),
    # By this time, the position was aligned in order to keep the two of them off, as they were starting to get the same stake as the mask started.
    ...
    ("２７面で思いのほか苦寀戦し、ソア宴ラとｔ保はと烽もに残闔りゼ鴻ロ。",
    ""),
    ...
    ("伸びをして席を立つと、ギャャ宴ラ潟リーが３、４人ほどオ激レたちのエンディングを見ていることに気がついた。",
    ""),
    # As I stood up, I noticed that about three or four of them were watching the ending of the geisha banquet and lagata ly.

    ("もしかして、オ激レと志保のあさましい闘いを全泊部見てたのかぁ？",
    ""),
    ...
    ("「竅や竄やっ、どーもどーも」",
    ""),
    # "You're tampering, hilarious, hilarious."

    ("志保のрヤツは、のんきにギャャ宴ラ潟リーに愛想を振關りまいている。",
    ""),
    # Shiho's р guy is caring about his carefree love for Gyabanquet Lagatali.

    ("「なに竄やってんだよ」",
    ""),
    # "What are you doing?"

    ("「いいじ痰ゃん。あたしたち、全面ク潟リアしたのよ？	偉いってことでし蛯ょ？」",
    ""),
    ...
    ("考えてみれば、コンティニャー無しで全面ク潟リアってのはそうそうできる墲わけじ痰ゃない。",
    ""),
    ...
    ("「竅やっぱ、あんたといっし蛯ょだと、楽しい墲わね〜」",
    ""),
    # "After all, it's fun to see you with me."

    ("外に出た途端、志保がしみじみと言った。",
    ""),
    # As soon as I left, Shiho said deeply.

    ("何気ない言葉だが、オ激レはその言葉に含まれた意味を聞き逃さなかった。",
    ""),
    # It's a casual word, but I didn't miss the meaning contained in the word.

    ("「なあ…。お前さ、あいつらといっし蛯ょだと楽しくないのか？」†",
    ""),
    ...
    ("き蛯ょとんとした顔の志保。",
    ""),
    # Shiho has a squealing face.

    ("「…内藤と長田だよ。いっし蛯ょだったんだｂ？	こっそり抜けてきてよかったのか？」",
    ""),
    # "...It's Naito and Nagata. Were you both ecchi b? Were you glad you sneaked through?"
    ...
    ("「お前が背伸びしてあいつらとつき№合ってんのは、オ激レ窿やｉ史からは見え見えなんだよ。…多分あかりに烽もな」",
    ""),
    ...
    ("「…なんかさ、時々增わかんなくなっち痰ゃうんだ。あのふたりの考えてること…」",
    ""),
    # "...I'm not sure I can understand it from time to time. What these two are thinking..."

    ("諱よう竄やく福口を開いた。",
    ""),
    # He opened his mouth with a fake name.

    ("「だｂ？	あんなノ潟リじ痰ゃねえよ、お前はさ」",
    ""),
    # "B? You're not phlegmy like that."

    ("「そんなことないってば」",
    ""),
    # "That's not the case."

    ("「じ痰ゃなんで勝闖手に抜け出してきたんだよ？」",
    ""),
    ...
    ("志保がそうつぶ竄やいたとき、ち蛯ょうど駅の入闢り福口にｒいた。†",
    ""),
    ...
    ("呼ばれて振關りｌいた。",
    ""),
    # I was called and called out.

    ("「協力プ激レイ、面猪白かったね」",
    ""),
    # "Cooperational Play, the face was white."

    ("竅やけに『協力』の部分を強調して言う志保。",
    ""),
    # Shiho clearly emphasizes the "cooperation" part.
