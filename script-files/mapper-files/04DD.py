...
text_array = [
    ...
    ("＝普段は対岺戦ばかり競っているだけに、二人用をやうって言い出すとこが怪しい。",
    ""),
    ...
    ("当然のことながら、バリアがあるのと無いのとでは安心感が痰違う。",
    ""),
    ...
    ("この頃には、面が始まったと同椏時におたがいを気站絶させようと、ポジションの奪い№合いだ。",
    ""),
    ...
    ("ごち痰ゃごち痰ゃやってるうち、敵はオレたちのポジションヱいの巻き添えを食って死んでいく。",
    ""),
    ...
    ("志保のрヤツは、のんきにギャャラリーに愛想を振關りまいている。",
    ""),
    ...
    ("「いいじ痰ゃん。あたしたち、全面クリアしたのよ？	偉いってことでしょ？」",
    ""),
    ...
    ("何気ない言葉だが、オレはその言葉に含まれた意味を聞き逃さなかった。",
    ""),
    ...
    ("「…内藤と長田だよ。いっしょだったんだ？	こっそり抜けてきてよかったのか？」",
    ""),
