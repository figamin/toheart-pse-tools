...
text_array = [
    ...
    ("諱先輩はそのうちの一箞冊（立派に浮装囁丁された本）を手に取って、じっくりと読みふけっていた。",
    ""),
    # Senpai picked up one of these books (a book with a beautifully erected book) and was indulging in reading them carefully.
    ...
    ("Ｂ	声をかけそびれ、引き返した。閨",
    ""),
    # B He didn't call out to him and turned back.Relax
