...
text_array = [
    ...
    ("補習授業三厲日目。",
    ""),
    # The third day of supplementary lessons is now available.

    ("成績の悪い連中が、２−Ａの教室に集められている。",
    ""),
    # People with poor grades are gathered in the 2-A classroom.

    ("いま、このクラスをのぞけば、学年成績の盾ワースト軍団が一目瞭然だ。",
    ""),
    ...
    ("…って、寝てるよ、このバカ。",
    ""),
    # ...I'm sleeping, this idiot.

    ("オレが真面目に悩んでるってのに、気搴持ち良さそうに盾居眠りしやがってぇ。",
    ""),
    ...
    ""),
    # However, even though I was sitting next to him, I couldn't get any phlegms as far as I could reach him.

    ("離齬れた鰍相闡手にちょっかい出すには、やっぱ飛び道搭だな。",
    ""),
    ...
    ("すぐにこちらをにらみつける。",
    ""),
    # Immediately I glared at him.

    ("オレはニсヤニсヤ笑ってやった。",
    ""),
    # I laughed and smirked and tampered.

    ("志保は口パクでなにやら文蝠句を言ってる。",
    ""),
    # Shiho is making a lucky lip-syncing and saying tampering and sentences.
    ...
    ("バカなことに桙時間をｔ笏やしてしまった。",
    ""),
    # Idiot made the time t-scepter.

    ("プリントの空搭欄をр埋めることが目的だってのに、オレはなにをやってんだ。",
    ""),
    ...
    ("問題に四齊苦八齡苦してると、オレの頬になにかが飛んできて、跳ね返った。",
    ""),
    ...
    ("志保が飛ばした消しゴムのカスだ。",
    ""),
    # It's the eraser that Shiho skipped.

    ("まったく『目には目を』って辺阨りがこいつらしい。",
    ""),
    # It seems like this guy is completely 'eye for eyes'.

    ("なんて感心してる場㍼合じ痰ゃねえな。",
    ""),
    # What an impressive place is that you can't get enough phlegm.

    ("ムカついたが、ここでやり返したらただのガキだ。",
    ""),
    ...
    ""),
    # More than that, we need to close Pulato Rint soon.
    ...
    ("『背摧理法を用いて、氈次の命題を証明せよ』",
    ""),
    # "Use the sin-law method to prove the lifelong theme of the sin-law."

    ("う〜ん…。",
    ""),
    # Yeah….

    ("この手の問題は、解き方を忘齧れてしまったら、閨手のつけようがないんだよな。",
    ""),
    ...
    ""),
    # That amount of fragments... I can continue to attack and fire my fierce thrusts until this fox is over.
    ...
    ("もう、こうなったら我揄慢莓比べだ！",
    ""),
    # Now, when this happens, we'll have to make a trumpet comparison!

    ("あいつの気の済むまで…いや、消しゴムが全弾無くなるまで辛抱だ。",
    ""),
    # Until he feels good... be patient until he's tampered with it, and the eraser is gone.
    ...
    ""),
    # My geira was even more excited and regained his spirits in Pugata Rint.
    ...
    ("「君、長岡君。ちょっとｗなさい」",
    ""),
    # "You, Nagaoka-kun. Just a little slut lol."
    ...
    ("「君迪らの嘯答案用落を見骭ると、解嚔答涛欄がほとんどр埋まっていないじ痰ゃないか。この１桙時間、君迪らは遊んでいたのか？」",
    ""),
    # "When I saw the answers I had been missing out, I found out that the answer section was barely filled with phlegm. Did you guys play during this one time?"
    ...
    ("と、するどく突っ桙込んできた。",
    ""),
    # And he came in with a stern slam.
    ...
    ("「君たち、空搭欄がр埋まるまで帰驪ることは魔許さんぞ」Å",
    ""),
    # "You guys, you will not be allowed to go home until the airline is filled up." Å
