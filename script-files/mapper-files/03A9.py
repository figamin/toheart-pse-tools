...
# Source file: 03A9.txt

text_array = [
    ("（智子	回秤数イベント	帰闍り道	ＬＶ２）閨（選択綜Ｂ	まだまだ！	の続き）",
    ""),
    ...
    ("たしかに最燕初の頃に比べると１５秒近くは縮めたが、それでも志保のрヤツにはあともう１５秒くらいの差がある。",
    ""),
    ...
    ("実際に魔走ってる姿を想闡定すると、あいつのケツすら見えてないってことになるのか。",
    ""),
    ...
    ("諱画面に流齬れる、閨『メｃ盾ｏｎ№ｇ窒ｒ≠ａｔ浮ｕ撃ｌ≠ａｔ奄盾ｏｎ入！』閨	の輝く文囎字。",
    ""),
    ...
    ("あいつは、たしかに、そのくらいのタイムでゴールしたはずだ。",
    ""),
    # He must have reached the finish line at that time.

    ("だとしたら、あと１１秒。",
    ""),
    # If that's the case, then there's only 11 seconds left.
