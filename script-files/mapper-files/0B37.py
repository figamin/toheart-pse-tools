...
text_array = [
    ...
    ("「ううん、ぜんぜん痰違う。",
    ""),
    # "Yeah, the phlegm is completely different.
    ...
    ("「それよか、＝早く始めようぜ」",
    ""),
    # "That's right, let's start early."
    ...
    ("Ａ	今厓日は勝てそうな気がした。閨",
    ""),
    # A I felt like I could win on the day.Relax

    ("Ｂ	綾∴香の強さを痛感した。閨",
    ""),
    # B I was deeply impressed by the strength of Aya∴Kawa.Relax

    ("Ｃ	自分の未熟さを痛感した。閨",
    ""),
    # C I was deeply aware of my immaturity.Relax
