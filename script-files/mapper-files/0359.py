...
# Source file: 0359.txt

text_array = [
    ("（智子	好感度イベント	９回目）閨（選択綜Ａ＋＝ａからの続き）",
    ""),
    # (Tomoko's 9th Likeability Event) (Continued from Chosen A+=a)

    ("委員長は少し考えてから、",
    ""),
    # The chairman thought a little before
    ...
    ("「…く、くだらんこと言うてる暇あったら、はよ行くで。",
    ""),
    # "...Damn, if you have time to say stupid things, go ahead and go.

    ("時間がもったいない」",
    ""),
    # It's a waste of time."

    ("「はいはい、わーったよ。そのかわりрヤックだかんな」",
    ""),
    ...
    ("「とほほ、せっかく委員長とふたりでрヤックにｗたっていうのによ」",
    ""),
    # "Hey, I thought the two of us were going to the yacht together with the chairman lol."
