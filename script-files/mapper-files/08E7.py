...
# Source file: 08E7.txt

text_array = [
    ("（戟レミィ	好感度イベントＰＳ）閨（教室）†",
    ""),
    # (Karemi Likeability Event PS)Level (Classroom)†
    ...
    ("「生徒玄関の掲示板に、学校新聞が貼闢り出されてるよ」",
    ""),
    # "The school newspaper has been posted on the message board at the student's entrance."
    ...
    ("「のことが曹書いてあったよ」†",
    ""),
    # "It was written about Sao" †

    ("「そっか、忘齧れてたぜ…」",
    ""),
    # "I see, I forgot..."

    ("あいつは名前は出さないって言ってたが、とりあえず確認はしておかないとな。†",
    ""),
    ...
    ("℃面の一角、つまり土地を任されたからには、しっかりと責任を揩持って取闔り組みたいと思ってます。†",
    ""),
    # Since I was entrusted with a part of the °C surface, that is, a land, I would like to take full responsibility and take responsibility for it.†

    ("土地に住むには、家がなければいけません。",
    ""),
    # To live on the land, you need to have a home.
    ...
    ("…ヘ揀理雷だけは一流だな。†",
    ""),
    # ...Hey, Rirai is the first class.†

    ("さて、写真にある嘯建物です。",
    ""),
    # Now, here is the building shown in the photo.

    ("これは撮影用にр私が人づてで探し出した烽ものなのですが、偶然に烽もр私の知人の思い出の場鰹所で烽もあったのです。",
    ""),
