...
text_array = [
    ...
    ("「それって、神岸さんのことですか…？」",
    ""),
    # "Does that mean Kamigishi-san...?"

    ("「えっ？」",
    ""),
    # "Huh?"

    ("掾理女緒ち痰ゃん、あかりのこと知ってるのか。",
    ""),
    ...
    ("「あの、п私、パソコン揀持ってないから、そういう、イ、イ…インターネットみたいな話は、ぜんぜん詳しくなくて…」",
    ""),
    ...
    ("「あ、途湯までだったら、п私、べつに…」",
    ""),
    # "Oh, if it's just a short distance, I'll be a little..."
    ...
    ("「あの子ほどの手だれが、のどこにひかれたのかしら？」",
    ""),
    # "Who was hit by that girl, and where?"
    ...
    ("「あんまりうるせーと、おいてくぞ」",
    ""),
    # "Shut up too much, I'll leave it there."

    ("「はん。『ただの友だち』には、ずいぶんそっけないのね。",
    ""),
