...
text_array = [
    ...
    ("戟レミィは少し緊張した面摶持ちで百円玉を取闔り出すと、梶投涛茁口へ冾放阨り桙込んだ。",
    ""),
    ...
    ("そんなことはお構いなしで、戟レミィはペシペシとボタンを叩く。†",
    ""),
    # Without caring about that, Karemi hits the button.†

    ("「おいおい、始まってから少し烽も動いてないぞ。",
    ""),
    ...
    ("ゲームのボイス諠より、さまになった発音で、戟レミィが声を繧上げる。†",
    ""),
    ...
    ("諱取闔りあえず、戟レミィにｊんで烽もらえたし、結果オー堰ライにしておこう。◯",
    ""),
