...
text_array = [
    ...
    ("「ち痰ゃん、なにが食べたい？」",
    ""),
    # "Chiffonya, what do you want to eat?"
    ...
    ("「で、結局、なにｍってくれるんだ？」",
    ""),
    # "So, what will you end up giving me?"

    ("「ふふふっ、それは、出女てからのお楽しみということで」",
    ""),
    # "Hahaha, that's what I'm looking forward to after I'm coming out."
    ...
    ("「なあ、まだ、＝早いんじ痰ゃねーのか？」",
    ""),
    # "Hey, it's still too early, isn't it?"
