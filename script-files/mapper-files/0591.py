...
text_array = [
    ...
    ("「そんなことはないですよ。慣れないうちはつらいか烽もしれませんけど、冝日課になれば、磨当たり前になりますから」†",
    ""),
    ...
    ("「けどオ激レ、朝は駄目なんだ。",
    ""),
    # "But I'm super bad, mornings are no good.

    ("夜は強いけど」",
    ""),
    # It's strong at night."

    ("「だったら夜で烽もいいと思います。とにかく少しずつ、いきなり無ヶ茶しないで、だんだん冾日課にしていくことが蛯大切です」",
    ""),
    ...
    ("「…うーん、そうだよなあ。技うんぬんより、竅やっぱ薰基本は体だ烽もんなあ…」†",
    ""),
    # "...Hmm, that's right. Rather than just the technique, the basics are the body..."†

    ("「とくに先輩はセンスがいいですから、体を鍛えれば、きっと強くなれますよ」",
    ""),
    # "Seniors in particular have good taste, so if you train your body, you'll definitely be able to get stronger."
    ...
    ("頑張ってください！」Å",
    ""),
    # I wish you the best!Å

    ("その冾日燗も、禔練習は夕髣暮れまで続いた。",
    ""),
    ...
    ("本を受け取って言うと、葵ち痰ゃんは嬉しそうに微笑んだ。◯",
    ""),
    # When I received the book, Aoi Chisho-yan smiled happily.◯
