...
text_array = [
    ...
    ("危ないからってオ激レが逃げたら、琴音ち痰ゃんはどうすんだよ。このまま、独闢りぼっちで生きてくつ烽もりなのか？」†",
    ""),
    ...
    ("超能力が原因で、琴音ち痰ゃんがｎ囲のみんなから気味悪がられてるってこと。",
    ""),
    ...
    ("オ激レは自分のこと善人だなんて、思っち痰ゃいないが、ここで彼濫女を見捨てるほどの悪人で烽もないと思っている。†",
    ""),
    ...
    ("「｢｢少しで烽もコント鴻ロールできるんだｂ？	じ痰ゃ頑張って全泊部コント鴻ロールしちまおうぜ」",
    ""),
