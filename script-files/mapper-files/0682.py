...
text_array = [
    ...
    ("「担亦当謫区諡域は、どっからどこまでだ？」",
    ""),
    # "Where is the area of ​​the kingdom region from?
    ...
    ("…げげっ、こり痰ゃ結構な面積があるな。",
    ""),
    # ...Oh, there's quite a bit of space to get rid of the stiff phlegm.

    ("「でも、こっち側の半分は終尞わってますから、あとはこっち側の半分だけでーす」",
    ""),
    # "And the other half of the hot side is over, so all that's left is the half of this side."
    ...
    ("んじ痰ゃ、おっ始めますか。",
    ""),
    # I'm not going to start with phlegm.
    ...
    ("ぺたぺたぺたぺたぺたーーーーーーーっ。",
    ""),
    # It's peeling, peeling, peeling.

    ("「す、すごいっ！	気㈲合いが入ってますっ」",
    ""),
    # "S---That's amazing! It's got a lot of excitement."

    ("「そうだ。掃恆除はなにより気㈲合いが肝心だ。",
    ""),
    # "That's right. The most important thing when it comes to cleaning and eliminating is to be more careful.

    ("チンタラ窿やってたんじ痰ゃ、いつまで経っても終尞わり痰ゃしねーぞ」",
    ""),
    ...
    ("速攻で片をつけるぜ！」",
    ""),
    # Let's put on the slits quickly!”
    ...
    ("「…は、はい、すごいです。ほんとにあっという間に終尞わっち痰ゃいました」",
    ""),
    # "...Yes, that's amazing. I really got a lot of phlegm in a flash."
    ...
    ("「いえ、ちっとも。とっても楽しかったです。だれかといっしょにお掃恆除するのって、こんなにも楽しいものなんですね。",
    ""),
    ...
    ("「でも、さんがこんなにお掃恆除好きな方だとは知闥りませんでした。じつは、わたしもお掃恆除蜿大好きなんですよー」",
    ""),
    ...
    ("「オレはべつに、掃恆除が好きだからいっしょにやってたわけじ痰ゃねーんだぞ？	ひとりで掃恆除してるマルチが大変そうだったから、閨手伝ってやったんだ」",
    ""),
    ...
    ("「ほ、本沫なら、香ロボットであるこのわたしがお手伝いしなき痰ゃならない立齬場なのにっ！",
    ""),
    # "Wow, if it's a real droplet, this incense robot, is a place where I have to help out!

    ("、さんには、これでもう２回目の迷惑ですーーーーっ！」",
    ""),
    ...
    ("「堰初めて出初ったときといい、さんってとっても親切な方なんですね」",
    ""),
