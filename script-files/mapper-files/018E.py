...
text_array = [
    ...
    ("しばらくして、また戻ってくる。",
    ""),
    # After a while, I'll come back again.
    ...
    ("だけど、べつに口伯数が減ったからと言って気まずくなる関係でもない。",
    ""),
    # However, just because Fukuguchi's number has decreased, it's awkward, so there's no hot water.

    ("話すことがあれば話しかけるし、なければし痰ゃべらない。",
    ""),
    # If there's anything to talk about, I'll talk to him, and if I don't, I won't sputum.
    ...
    ("要は疲齡れない間柄ってわけだ。",
    ""),
    # In short, a relationship that doesn't get tired is what happens.
    ...
    ("「あ、そういえば、おモ父さんが『久しぶりにおもしいр推攝理小熄説だぞ』って貸してくれたのがあるけど、読む？」",
    ""),
    ...
    ("「あ〜？	п推攝理小熄説かァ」",
    ""),
    # "Ah? Is it the theory that пShopping Lingerie?"

    ("「たしか、ナニナニ賞をとったとか、とらなかったとか」",
    ""),
    ...
    ("「あっ、もう、いじわる〜」",
    ""),
    # "Ah, I'm going to get it right now~"
    ...
    ("「もし、とある旅行謐先で殺人事庶件が発生して、まわりの人がばたばた死んでって｢｢」",
    ""),
    ...
    ("「たとえば…の話だよ。｢｢で、生き残ったなかにр私とち痰ゃんがいて、もしかして、п私に犯人の疑いがあったら、どうする？」",
    ""),
    # "For example... I'm talking about... "So, among the survivors, there are me and some spurts, and maybe I'm suspected of being the culprit, what would you do?"
    ...
    ("Ｂ	自首をうながす。閨",
    ""),
    # B: I encourage myself to turn myself in.Relax
