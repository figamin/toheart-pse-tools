...
# Source file: 0105.txt

text_array = [
    ("（あかり	冝日付イベント１．３）閨（３月１５冾日）閨（あかりと勉強状態なら発生）閨（ＡＭ１１桙時）閨（校門外）",
    ""),
    ...
    ("諱取りあえず今厓日はグラマーだけをやることにし、化学は明坙日の冾日曜坥日に回すことにした。",
    ""),
    ...
    ("「…ええっと、（	）内の語を並びかえて、冝日本齧語と同じになるように英文を完成させよ。まいどおなじみのрヤツだな」",
    ""),
    # "...Um, change the words in ( ) and complete the English sentences so that they are the same as Japanese bellies. You're the familiar р guy."

    ("「彼女はとても親切な子だから、皆に好かれている」",
    ""),
    # "The boyfriend and woman is very kind, so everyone likes her."

    ("「（＝ａ／入／堰入／ａ凾ｙ／入盾ｏ／≠魔ｖ窒ｒ凾ｙ",
    ""),
    # "(=a/in bb/weir i-Tangent/ab y/injected shield/≠ma vb nitrogen y

    ("ｏｎ／駆奄ｎрｄ／ｌ盾ｏ魔ｖрｄ／〟ｇ奄窒ｒ撃ｌ／閨",
    ""),
