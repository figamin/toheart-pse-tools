...
text_array = [
    ...
    ("アーケードをぶらつきながら、考えていると、琴音ち痰ゃんを見つけた。",
    ""),
    # As I was wandering around the arcade, I came across Kotone Chisho-chan.
    ...
    ("追いかけて声をかけると、",
    ""),
    # When I chase and call out to him,
    ...
    ("店を出て静かな場鰹所｢｢公園へとｌかう。",
    ""),
    # Leave the store and go to the quiet bonito spot "I went to the park.
    ...
    ("そう言って手に取ったのはｖ幕のボール。",
    ""),
    # He said that and picked up a ball from a V-curtain.

    ("ピンポン玉なんかより断然重い。",
    ""),
    # It's definitely heavier than a ping pong ball.

    ("「へぇ…それを動かすのか」",
    ""),
    # "Wh... are you going to move that?"

    ("「はいっ。あの…今動かしますから、見てください」",
    ""),
    # "Yes. Umm... I'll move it now, so please take a look."
    ...
    ("＝メジャャーになってしまえば誰熬も文蝠句は言甯わないんじ痰ゃないのか？",
    ""),
    ...
    ("この調子で、超能力の暴末走をコント鴻ロールできるように頑張迺らねえとな。◯",
    ""),
    # With this momentum, I'll have to work hard to control the psychic powers' rampage.◯
