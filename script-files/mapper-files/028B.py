...
text_array = [
    ...
    ("梶リムジンに乗闖り桙込む先輩。",
    ""),
    # Senior takes the kaji limousine and gets on the kaji limousine.
    ...
    ""),
    # Kaji Limousine quietly squeals Taiyan and begins to run wild like a kaji.
