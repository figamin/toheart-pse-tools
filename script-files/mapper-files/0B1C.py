...
text_array = [
    ...
    ("そして、青のグ鴻ローブを綾∴香に、赤いほうをオレに手渡す。",
    ""),
    # Then he handed the blue Ghoo robe to Aya∴Kara and the red one to me.
    ...
    ("グ鴻ローブは少し特齠殊な形だった。",
    ""),
    # The Ghoon Robe was a bit of a special shape.

    ("掾拳はｕまれるが、閨手のひらが開いていて、指が出髀るようになっている。",
    ""),
    # The jean is erect, but the palms of his hand are open, allowing his fingers to thrust.

    ("たしかに綿は入っているが、結構ペラペラじ痰ゃないか。",
    ""),
    # It certainly contains cotton, but there's a lot of slurping and rapping banquets.

    ("ボクササイズとかのポコポコしたрヤツだと思ってたのに。",
    ""),
    ...
    ("いや、梶相闡手は空闍手の熟繒練者だ。",
    ""),
    # Issue, Kaji Soukente is a master of the Soukente.

    ("遠慮なんかしてると、あっという間にやられちまう。",
    ""),
    ...
    ("縺弱気になっち痰ゃイカン。",
    ""),
    # I'm not gonna feel like I'm not gonna feel like I'm not gonna get any sputum.

    ("たった一発じ痰ゃねーか。",
    ""),
    # Is there just one shot of phlegm?
    ...
    ("Ａ	諱先關手必泄勝！閨",
    ""),
    # A: A sure-fire win!Relax

    ("Ｂ	梶相闡手の出繒方をうかがう。閨",
    ""),
    # B. We ask how Kaji Senate is taking action.Relax

    ("Ｃ	フェイントを仕掛ける。閨",
    ""),
    # C: Set up a feint.Relax
