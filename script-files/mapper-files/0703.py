...
text_array = [
    ...
    ("「超能力？	どうかしらね〜」",
    ""),
    # "Psychic powers? I wonder what?"

    ("「オ＜メーこそ、そのいい加減な嘯答えはなんなんだよ」",
    ""),
    # "Oh, what's that sloppy answer?"

    ("「超能力が存在するなら、それを証明するのはこのあたし。それだけね」",
    ""),
    ...
    ("ら、調べてんのよ。あんたたちには途湯経過をニャースとしてお翌送闡りしてるだけよ」",
    ""),
    ...
    ("「これからは、もっとあたしの薰情報を信用することね」",
    ""),
    # "From now on, I'll trust my information more."
    ...
    ("「んじ痰ゃ、今厓日の志保ち痰ゃん薰情報はおしまい。他のみんなが待ってるから、シー＜〜」",
    ""),
    # "The information on Shiho's sphin is over now. Everyone else is waiting for me, she <~"
    ...
    ("超能力ってホントにあんのかな？◯",
    ""),
    # Is there really psychic powers?◯
