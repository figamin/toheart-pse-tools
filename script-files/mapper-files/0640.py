...
text_array = [
    ...
    ("ま、まさか、ホントに言葉が通じてる｢｢黽",
    ""),
    # Well, I can't believe that the language is really "おうかないます"
    ...
    ("わたしは食べられないので、犬さんにあげます。",
    ""),
    # I can't eat it, so I'll give it to the dog.
    ...
    ("「おいしいって、どういう気搴持ちですか？」",
    ""),
    # "What kind of mood does it last for you, say it's delicious?"
