...
# Source file: 07A1.txt

text_array = [
    ("（琴音	回秤数イベント	学校を出髀る	選択綜Ａ）†",
    ""),
    # (Kotone Scales Event: Departing from School, Chosen A)†
    ...
    ("「そり痰ゃあ、なんたって冾放課繪後だからな」†",
    ""),
    # "Ah, after all, it's after the school day."
    ...
    ("「あの…今厓日はさんとお話しながら帰闍りたいなって思って…」",
    ""),
    # "Um... I'm thinking I'd like to go back to talk to you right now..."

    ("「おっ、それはデートのお誘いだな？	いいぜ、どこで烽もつき№合うぞ」†",
    ""),
    ...
    ("Ｂ	ゲーセンの話陂題。閨",
    ""),
    # B: A story about the arcade.Relax
