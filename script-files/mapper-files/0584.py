...
text_array = [
    ...
    ("「うん。葵ち痰ゃんって、禔練習に打ち桙込んでいるときもそうだけど、クラブ勧誘のときも、いまの話し方熾も、なんにでも一生恊懸命でさ、気搴持ちいいっていうか。そういうとこ、オレも見習いたいよ」",
    ""),
    ...
    ("「п私って、﨟基本的に才能ない人間ですから、なんにでも努力しないと、人並みに追いつけないんですよ」",
    ""),
    # "I'm basically a talented person, so I have to work hard on everything, and I can't keep up with the average person."

    ("そう言って、葵ち痰ゃんは恥ずかしそうに笑った。≠",
    ""),
