...
# Source file: 0587.txt

text_array = [
    ("（葵	回秤数イベント３）閨（２Ｆ廊下）",
    ""),
    # (Aoi Episode Scales Event 3) Lin (2F corridor)

    ("諱よし、葵ち痰ゃんのとこに行くか。◯",
    ""),
    # Okay, let's go to Aoi Chisho-chan's place.◯

    ("「はぁい、そこの暇オトコ」",
    ""),
    # "Yes, a guy out there."

    ("下駄箱を出たと同椏時に、縺後撃から軽い声に呼び止められた。",
    ""),
    # As I left the shoe cabinet, I was stopped by a light voice after the attack.
    ...
    ("「ホント、失邇礼なрヤツ諠よねぇ、あんたって」",
    ""),
    # "Really, you're a rude sinful guy."

    ("「はいはい。で、暇オンナがなんのようだ？」",
    ""),
    # "Yes, yes. And what does it look like a boring woman?"
    ...
    ("言い捨てて、行こうとする。",
    ""),
    # I'll give up and try to go.

    ("「ほほう。で、あんたは、これからひとりでお楽しみっと」",
    ""),
    # "Ahhh. And you'll be looking forward to it on your own from now on."
    ...
    ("夕焼け空の真っ赤な鰍炎に溶けながら、葵ち痰ゃんは本坙日最纃後のスパートを行っていた。",
    ""),
    ...
    ("ナイ鴻ロン袋に入齠れて、潤縁の下に片づける。",
    ""),
    # It is placed in a Nyong Long bag and tidys away under the sin.
    ...
    ("まるで、ぱっと花が開くように、葵ち痰ゃんの表﨣情が明髢るくなった。",
    ""),
    ...
    ("「じ痰ゃあ、ひとつ、その体験兼箔部ってことで」",
    ""),
    # "Ah, that's just one experience and a foil section."
