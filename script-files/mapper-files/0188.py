...
text_array = [
    ...
    ("縺後撃からそっとのぞき桙込んでみた。",
    ""),
    # After the attack, I gently peered in.
    ...
    ("「お客さん、困闕りますね」",
    ""),
    # "You customers are having trouble."
    ...
    ("「ううん、そんなことないよ。新しい本には必ずなにか新しい発見があるんだよ」",
    ""),
    # "Uh, that's not the case. There's always something new to discover in new books."
    ...
    ("「諱よーし、じ痰ゃあ今度、弁抹当搏持ってくようなイベントがあったら、それな」",
    ""),
    # "Okay, I'll give you a sputum next time, if there's an event where you'll be holding your mouth off, that's it."
    ...
    ("「花見か…」",
    ""),
    # "Could you like cherry blossom viewing?"
    ...
    ("「氏去年みたいなのなら、もうたくさんだ」",
    ""),
    # "If it's like last year, then there's already a lot."
    ...
    ("Ｂ	暇だったらな。閨",
    ""),
    # B I wish I had free time.Relax

    ("Ｃ	考えとくよ。閨",
    ""),
    # C I'll think about it.Relax
