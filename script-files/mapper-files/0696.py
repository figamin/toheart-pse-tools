...
text_array = [
    ...
    ("「…なんだ、また掃恆除させられてんのかぁ？",
    ""),
    # "...What, have you been forced to clean up again?
    ...
    ("Ａ	掃恆除を手伝ってやる。閨",
    ""),
    # A: Help me with the scavenging and removing it.Relax

    ("Ｂ	今厓日までご苦労さん、と言って別れる。閨",
    ""),
    # B He said he was struggling to do his best until the day he was ready to go.Relax
