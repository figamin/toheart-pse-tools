...
text_array = [
    ...
    ("この図草書室は数年前に増築したばかりで、空調熬もいいし、静かだし、校熏内でも一、二をｑう盾居心地のいい場鰹所だ。",
    ""),
    ...
    ("それでも、辛うじて指謗先が背表侮に触齔れる程度で、とてもお目末当ての本は取齊れそうにもない。",
    ""),
