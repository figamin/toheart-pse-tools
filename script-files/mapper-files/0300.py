...
text_array = [
    ("（智子	出初いイベント）閨（３獅月１０冾日	氏月曜坥日）閨（昼休み）閨（教室）†",
    ""),
    ...
    ("すっきりし、教室へと戻髢る途湯の廊下で、",
    ""),
    # I was relieved and returned to the classroom, in the hallway of the treadmill.
    ...
    ("という墲わけで、図草書室。",
    ""),
    # That's why the cursive library is here.

    ("この図草書室は数年前に揩増築したばかりで、空調熬もいいし、静かだし、校熏内で烽も一、二をｑう盾居心地のいい場鰹所だ。",
    ""),
    ...
    ("「返す前に、氈次に借闔りる本を探してこようと思うんだけど」",
    ""),
    # "Before I return it, I'll try and find a book to borrow from next."

    ("「おう、行ってこい。ここで待ってるから」",
    ""),
    # "Oh, go, I'll wait here."

    ("「ち痰ゃん烽も、たまにはなにか借闔りたら？",
    ""),
    # "Why don't you borrow something once in a while, too?

    ("意外に読みたい本が見つかるか烽もしれないよ」",
    ""),
    # Surprisingly, I don't know if I'll find a book I want to read."
    ...
    ("どう烽もこういうのは、借闔りるのはと烽もかく、返しにくるのが面倒くさくて気が乗迴らない。",
    ""),
    ...
    ("£には烽もしかしたら本末当に面猪白そうな本があるか烽もしれないしな。†",
    ""),
    ...
    ("それで烽も、辛うじて指謗先が背表侮に触齔れる程度で、とて烽もお目末当ての本は取齊れそうに烽もない。",
    ""),
