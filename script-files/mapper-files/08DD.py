...
# Source file: 08DD.txt

text_array = [
    ("（レミィと志保と勉強	３／１６）閨（潤居間	驕夜）",
    ""),
    # (Warremy, Shiho and Study 3/16) (Jun Living Room, Azuma Night)

    ("もう夜だ。",
    ""),
    # It's already night.

    ("志保のたっての希望で、勉強級は夕食辮後からとなっている。",
    ""),
    # At Shiho's very request, the study class will begin after dinner.

    ("あいつ、なんだか知迺らないけど夜が好きだ。",
    ""),
    # He's a bit unfamiliar with me, but I like the night.

    ("驕夜の学校とか夜の公園とか、頭に『驕夜の』が付くような場鰹所が特に。",
    ""),
    # Especially bonito spots where you can see arrogant night schools and night parks, and arrogant night spots that have arrogant night's head on.

    ("掾理由は考えないでおこう。",
    ""),
    # Don't think about the reason.

    ("あいつの行動パターンなんて、聞いてもどうせ不条搶理なだけだ。",
    ""),
    # When I hear about his behavior patterns, it's just that he's just irrational.

    ("それはともかく、レミィからばっちり教寀わって、英皷語の点を上げないとな。",
    ""),
    # That's what I have to do with the help of Heremy, and to give a clear guide to the English language.

    ("なんせ、下濶手したら先生謳より詳しいかもしれないんだ。",
    ""),
    ...
    ("「氈勝闖手知ったるの家〜って、ふ〜ん、あんたの家ってこうなんだぁ」",
    ""),
    # "The house I learned about, hmm, what is your house?"

    ("「％體るの奄初めてのクセに、なにが勝闖手知ったるだよ」",
    ""),
    ...
    ("「おう。とっとと上がってくれ」",
    ""),
    # "Oh, just go up quickly."

    ("志保なんかと痰違って、レミィはち痰ゃんと玄関絈口で待っている。",
    ""),
    # Unlike Shiho, the phlegmy is waiting at the entrance.

    ("轣育ちの痰違いだな…。",
    ""),
    # It's a different kind of phlegm when you grow up...

    ("「おじ痰ゃましマ〜ス」",
    ""),
    # "My old man's phlegm"

    ("レミィはものめずらしそうに辺阨りを見回している。",
    ""),
    # Karemi looks around at the bay with a sluggish look on his face.

    ("それも嬉しそうに。",
    ""),
    # That also looked happy.
    ...
    ("レミィと盾居間に戻髢ると、志保のрヤツはテーブルにモ買ってきたジャース窿やらお菓子竡やらを広げている。",
    ""),
    ...
    ("「Ｗ奄撃ｌ撃ｌ	Ｍ≠ａ窒ｒ凾ｙ	＝ａｎрｄ	Ｂ奄撃ｌ撃ｌ	メｃ盾ｏ高ｍ	≠窒ｒ？",
    ""),
    ...
    ("すると、レミィはすらすら嘯答えた。",
    ""),
    # Then, Remy replied slenderly.

    ("「ウォント？	それが短縮形じ痰ゃねえのか？」",
    ""),
    # "Want? Is that a shortened form of phlegm?"
    ...
    ("「『ｗ盾ｏｎ’ｔ』は『ｗ奄撃ｌ撃ｌ	氏ｎ盾ｏｔ』の短縮形ね」",
    ""),
    # "'Bath lol Shield O Lion't' is an abbreviation of 'Bath lol Amai Shot Lion't'"

    ("辞綜書をめくった志保が言う。",
    ""),
    # Shiho says, turning through the dictionaries.
    ...
    ("「だってな、疑站問文の嘯答え方は主齊語と動兼詞の否阡定形でだ？	動兼詞が翌ｗ奄撃ｌ撃ｌだから、否阡定形が翌ｗ奄撃ｌ撃ｌ	氏ｎ盾ｏｔで｢｢」",
    ""),
    ...
    ("冝日本齧語ぺらぺらだからといって、オレたちが今すぐ曹国鼾語の先生になれないのと同じで、レミィも英皷語の先生にはなれないんだ。",
    ""),
    ...
    ("それでも撃レミィから正解だけを聞いて、解嚔答を丸暗記する≠普通の勉強をした。",
    ""),
