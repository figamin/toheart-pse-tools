...
text_array = [
    ...
    ("志保なんかと痰違って、戟レミィはち痰ゃんと玄関絈口で待っている。",
    ""),
    ...
    ("「で烽も、それじ痰ゃ語伯数が多い墲わよ？	じ痰ゃあ、無摶理笳やり押しこんじ痰ゃおっか？」†",
    ""),
    ...
    ("「『浴ｗ盾ｏ獅ｎ’ｔ』は『浴ｗ奄ｉ撃ｌ撃ｌ	氏ｎ盾ｏｔ』の短縮形ね」",
    ""),
    ...
    ("それで烽も撃レミィから正解だけを聞いて、解嚔答を丸暗記する≠普通の勉強をした。",
    ""),
