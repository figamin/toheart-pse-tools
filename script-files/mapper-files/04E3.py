...
text_array = [
    ...
    ("当機はこのあと、蛛大気雷圏を離脱、氈亜光速飛行で最燕初の目的地、金星へｌかいます』",
    ""),
    ...
    ("窓の下をのぞき桙込むと、どこの曹国だうか、街の明かりがかすかに見える。",
    ""),
    ...
    ("見骭ると、やけにまぶしい太陽の反対側に、ぼんやりと黄色味のかかった窒白い星が見えた。",
    ""),
    ...
    ("『当機は１分纒後、衛星フォボスと交差します。みなさま、右濶手をご翌覧ください』",
    ""),
    ...
    ("当機諡より翌距離２０怩万キ鴻ロ＜メートルで、梶相対速度は桙時速９怩万キ鴻ロで通過いたします』",
    ""),
    ...
    ("全員が見迪守骼るなかで、ジャャガイｃモみたいなрヤツがゆっくりと通闥り過ぎて行く…。",
    ""),
    ...
    ("オレには、すぐ近くを小さな石こが通闥りすぎてるようしか見えない。",
    ""),
