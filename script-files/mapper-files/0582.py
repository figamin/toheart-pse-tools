...
text_array = [
    ...
    ("いまじ痰ゃほとんど誰熬も寄闃りつかず、すっかりただの空き地と化している。",
    ""),
    ...
    ""),
    # In this case, how many members of Kuban Love are in all the night club?

    ("あのとき葵ち痰ゃんは、同好拷をｍ骰るための規闍定白数に桙満たないって言ってたから、かなり少ないってことだよな。",
    ""),
    ...
    ("そこには、サンドバッグを鰍相闡手に、ひとり蹴闖りの練習をする葵ち痰ゃんの姿があった。",
    ""),
    ...
    ("強烈な蹴闖りが叩き桙込まれるたび、木の枝に吊したサンドバッグが揺齬れ動く。",
    ""),
    ...
    ("だが、葵ち痰ゃんは気づかない。",
    ""),
    # However, Aoi Chisho-yan doesn't notice.

    ("かなり集薯してるみたいだ。",
    ""),
    # It seems like they're quite a collection of potatoes.
    ...
    ("サンドバッグのチェーンがきしむ。",
    ""),
    # The punching bag chain creaks.

    ("「はぁ…、はぁ…、はぁ…」",
    ""),
    # "Haa..., haa..., haa..."

    ("葵ち痰ゃんは揺齬れるサンドバッグに抱きつくと、動きを固定して、深く息を吐いた。",
    ""),
    # Aoi Chisho-yan hugged her shaking punching bag, then firmly moved and let out a deep breath.
    ...
    ""),
    # After taking a break, I picked up a sports towel with a squeal and a squeal on my forehead and wiped away the sweat.
    ...
    ("「いよっ、すげー蹴闖りじ痰ゃん」",
    ""),
    # "Yes, it's amazing that you're kicking me."

    ("さすがに今度は気づき、葵ち痰ゃんはこっちを振關り返った。",
    ""),
    # As expected, Aoi Chisho-chan noticed this time, and shook this back.
    ...
    ("「まあ、ぶらっと見物にね」",
    ""),
    # "Well, let's stroll around and take a look."
    ...
    ""),
    # "In fact, it's the first time I've ever visited by a senior.
    ...
    ""),
    # "...I'm the only one here. This torture is good."

    ("「ひとりって、葵ち痰ゃんだけってこと？」",
    ""),
    # "Does that mean that Aoi Chisho-ya just have to be alone?"
    ...
    ("「はい。…そうなんですけど、そのたったの４人がなかなか集められなくて」",
    ""),
    ...
    ("そういえば、更衣室がないのに、葵ち痰ゃんはどこでｒ替えてるんだう。",
    ""),
    # Come to think of it, even though there is no changing room, where do Aoi Chisho-chan go?
    ...
    ""),
    # When Aoi Chisho-yan said that, he was hit by a surge after the attack.
    ...
    ("もしよければ、またｗてください。",
    ""),
    # If you like, please come back again.

    ("月曜とｐ曜は個人的な都∮合でお休みですが、それ以外はｖ淫俣冾ｱこでやってますから」",
    ""),
