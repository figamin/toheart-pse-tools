...
text_array = [
    ...
    ("エンジンの回転箔数は、多すぎて烽も少なすぎて烽もダ＜メだ。Å",
    ""),
    ...
    ("エンジン回転を繧上げすぎた志保のマシンは、スタート直纈後、暴齧れ馬のように蛇行した。",
    ""),
    ...
    ("ムカつき度は痰低いか烽もしれないが、志保の真乱似をして言ったので、効果はあるか烽もしれない。†",
    ""),
    ...
    ("いつ烽もなら涼しい顔で言ってのける強がり烽も、引きつった顔だと単なるギャャグだ。†",
    ""),
