...
text_array = [
    ...
    ("足熨もとがよく見えないのか、つま先で一煦歩ずつ確認しながら、艨ゆっくり繧上っていた。†",
    ""),
    ...
    ("ふたつの段ボール箱が重たい音をさせながら階段を転がり獅落ちていった。",
    ""),
    ...
    ("ここ最近の≠メイド鴻ロボは、ぱっと見た程度じ痰ゃ人間と見分けのつかない烽ものが多い。",
    ""),
    ...
    ("「で烽も、階段から転げ獅落ちたりするなんて、結構ドジな最新型だな、お前は」",
    ""),
    ...
    ("「そういえば墲わたし、お仕鮪事の途湯でした。その箱をコピー室まで揩持っていかないと」†",
    ""),
    ...
    ("どさっと、もう１個の繧上に重ねると、二段になったそれをいっぺんに揩持とうとする。",
    ""),
