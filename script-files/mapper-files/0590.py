...
text_array = [
    ...
    ""),
    # "Talent, yes. I think it's a great talent to not think of effort as hard."
    ...
    ("これを知髓る者、これを好む者にしかず。これを好む者、これを楽しむ者にしかずってさ」",
    ""),
    ...
    ("「はい、п私、なんだか自信がでてきました！",
    ""),
    # "Yes, I'm starting to feel more confident!
