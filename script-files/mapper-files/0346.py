...
# Source file: 0346.txt

text_array = [
    ("（智子	好感度イベント１回目）閨（二つ目の選択綜）閨（選択綜Ａ	宦騒ぐ派	の続き）†",
    ""),
    # (Tomoko's first favorability event) (Secondhand selection) (Continued from Chosen Sou A: Continued by Chosen Sou A: Continued by)†
    ...
    ("「はずしたギャャグを嘯字にして烽も、輪をかけてさむいだけだ烽もんなー」†",
    ""),
    # "They're just swaying the gyagu that you've missed, but they're just swaying it with a circle."

    ("「けど、あれ烽もずいぶん浸透したよな。少し前までは笑い声だったけどさ」",
    ""),
    ...
    ("「そうか。俺は嘯字のほうがムカつくけどな」†",
    ""),
    # "I see. I'm more annoyed by the silence."

    ("こっちはこっちで盛關り繧上がり、′こうはｌこうで、また別の話陂題で盛關り繧上がってる。",
    ""),
    # This is a booming story, and another story is booming.

    ("とくに翌女子の一蝿部にうるせー連中がいて、教室はすっかり休み桙時間と化した。†",
    ""),
