...
text_array = [
    ...
    ("「いったいなんの真乱似だよ」",
    ""),
    # "What kind of a random look it's like?"
    ...
    ("女としての、魅力を研結してるの」",
    ""),
    # She strives to her charm as a woman."
    ...
    ("「あたしはねぇ、素敵な恋の出初いを≠めてるのよ。それを、さかりのついた猫みたいに｢｢」",
    ""),
    # "I'm ≠ the beginning of a wonderful love. I'm going to say that, like a cat with a surge of excitement, ""

    ("「ププッ、それナイス！	まったく、さかりのついた猫だ」",
    ""),
