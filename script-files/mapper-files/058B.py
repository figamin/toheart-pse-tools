...
text_array = [
    ...
    ("禔練習縁初叝日の今厓日は、空闍手における薰基礎的なことから教えてもらうことになった。",
    ""),
    ...
    ("「はい。ボクシングでは拳はインパクト档時にだけ握闊りますが、空闍手は拳竚や手首を痛めないように最燕初からしっかりと握驤るんです」",
    ""),
    # "Yes. In boxing, the slugs are only slugs when the impact is on, but the slugs are slugs firmly from the very beginning to avoid hurting the slugs or wrists."

    ("「ほほう」",
    ""),
    # "Hah" 

    ("「ではまず、小指から№順に、指謗先で付け根を押さえるように、しっかりと握ってください」",
    ""),
    # "Now, first, hold it tightly, starting with the little finger, starting with the number one, with a finger slander."

    ("「付け根を押さえるように…」",
    ""),
    # "Stop the base..."

    ("「そうです。そして最纃後に親指で、人差し指とｒ指をグッと押さえます」",
    ""),
    # "That's right. And at the very least, I press my thumb down my index finger and r finger."
    ...
    ("自分の指を握驤るような感じだな。",
    ""),
    # It feels like I'm squeezing my fingers.

    ("「実際にパンチを魔当てる部分は、人差し指とｒ指の付け根剥部分です。",
    ""),
    # "The part where you actually hit the punch is the part where the index finger and r finger are peeled off.

    ("拳のｒで、いちばん硬い部分ですよね」",
    ""),
    # It's the hardest part of the fist, isn't it?

    ("「なるほど」",
    ""),
    # "I see"

    ("「あと、打つときは、′して手首を曲げないようにしてください。",
    ""),
    # "Also, when you hit, make sure you don't bend your wrists.

    ("負担がかかって手首を痛めてしまいますから」",
    ""),
    ...
    ("その他にも、﨟基本の立ち方笊や構え方など、葵ち痰ゃんは自分の練習そっちのけで、一から十まで、こと細かに指導してくれた。",
    ""),
    ...
    ("「あの、﨟基礎羡練習をつまらないとは思寬わないでくださいね。熟繒練者でもいきつくとこは薰基礎羡練習なんです。",
    ""),
    ...
    ("三寬戦立ち、前窓立ち、縺後結立ち…。",
    ""),
    # The battle for the Sandwich, the front window stands, and the hangs behind the snake...

    ("｢｢裵基本の受け。",
    ""),
    # "The basics of the support.

    ("縺上段受け、外受け、内受け…。",
    ""),
    # Top-level receiver, outside-level receiver, inside-level receiver...

    ("｢｢裵基本の攻ｍ撃、素振關り。",
    ""),
    # "The basic attacks and M attacks and basic attacks.
    ...
    ("縺後片づけがすんで帰闍り支度が整ってから、葵ち痰ゃんが笑顔でオレに言ってきた。",
    ""),
    # After I finished tidying up, I went home and was ready, and Aoi Chisho-chan said to me with a laughing face.

    ("「諱先輩って、センスがいいんですね」",
    ""),
    # "Senior Ie has a good sense of style."

    ("「え？」",
    ""),
    # "picture?"

    ("「﨟基本技のひとつひとつがすごく綺淏麗です。とても奄初めてとは思えないくらい」",
    ""),
    # "Each of the basic technique is so beautiful. I can't believe it's the first time in Amami."

    ("「そう？」",
    ""),
    # "yes?"

    ("「はい。体重移動シフトウエイトとか、力の抜き方とか、諱よくわかってるっていうか」",
    ""),
    ...
    ("Ｃ	こういうことには自信があるんだ。閨",
    ""),
    # C I'm confident in this kind of thing.Relax
