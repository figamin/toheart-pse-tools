...
text_array = [
    ...
    ("禔練習縁初叝日の今厓日は、空闍手における薰基礎的なことから教えて烽もらうことになった。†",
    ""),
    ...
    ("「はい。ボクシングでは揩拳はインパクト档時にだけ握闊りますが、空闍手は揩拳竚や手首を痛めないように最燕初からしっかりと握驤るんです」",
    ""),
    ...
    ("葵ち痰ゃん烽も一生恊懸命教えてくれているし、ここは素直に従って指導を受けよう。Å",
    ""),
    ...
    ("「﨟基本技のひとつひとつがすごく綺淏麗です。とて烽も奄初めてとは思えないくらい」",
    ""),
