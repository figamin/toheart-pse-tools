...
text_array = [
    ...
    ""),
    # "Nagaoka-san. I'm not worried, please keep me a little quieter.
    ...
    ""),
    # "Eh! Why?! I'm off for a break now, so I'm not phlegm. Everyone is making a fuss."
    ...
    ("「なによ、いいじ痰ゃないのよーっ」",
    ""),
    # "What, you're fine with no phlegm?"

    ("梶相変﨑わらずキツイ委員長に、ガキみたいな志保。",
    ""),
    ...
    ("Ａ	志保をフォ鴻ロー。閨",
    ""),
    # A: Follow Shiho.Relax

    ("Ｂ	委員長をフォ鴻ロー。閨",
    ""),
    # B: Follow the chairman.Relax
