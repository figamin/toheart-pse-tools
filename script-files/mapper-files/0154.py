...
text_array = [
    ("（あかり	冝日付	好感度イベント９）閨（５月１冾日限定）閨（好感度イベント８を見た）閨（１桙時間目の休み桙時間）閨（教室	休み桙時間）",
    ""),
    ...
    ("その冾日の１桙時間目の休み桙時間。",
    ""),
    # The first frame time on that day was closed.
    ...
    ("自然な感じで微笑みを返したつもりだが、わずかにぎこちないものになってしまう。",
    ""),
    ...
    ("あかりが目の前に現鼬れた瞬間、思寬わず胸がどきっとしたのだ。",
    ""),
    # The moment Akari appeared in front of her eyes, my heart blew through my heart.

    ("どうやらオレは、自分でも気づかないうちに、あかりを強く意識しちまってるらしい。",
    ""),
    # Apparently, I'm becoming more and more aware of Akari without even realizing it.

    ("まあ、無摶理燉もないか。",
    ""),
    # Well, isn't there any unresolved logic?

    ("これまでずっと、おたがいに翌距離を保ってきたふたりなのに、ここへｗて突然、蛛大きく一煦歩前に踏みだしちまったもんな。",
    ""),
    # Until now, the two of them have kept their distance the next day, but then, they suddenly started stomping on their feet before they even stepped on.

    ("いままで通闥り、自然な感じでつき№合えってほうが、逆に入しいぜ。",
    ""),
    ...
    ("うれしそうな顔でうなずく、あかり。",
    ""),
    # Akari nodded with a happy look on her face.
    ...
    ("「お夕飯剥ってあげようと思って」",
    ""),
    # "I was thinking of peeling off dinner."
    ...
    ("最近近葛所の定食屋煢もすっかり食いつくし、堰ラー＝メンも、コンビニの弁抹当燗も、ほか弁熾も、ファーストフードも、どれももうマンネリでげっぷ気味だ。",
    ""),
    ...
    ("家薗料摎理に飢えているのだ。",
    ""),
    # Iezono Ryo is hungry for the scientist.
    ...
    ("ってことは、今骰夜はあかりとふたりっきりじ痰ゃないか。",
    ""),
    # That means that at this time, Akari and I can't just have a clear phlegm for the night.

    ("誰熬もいない家にふたりきり。",
    ""),
    # They are alone in a house where no one is allowed.
    ...
    ("「どうしたの？	さっきから変だよ？」",
    ""),
    # "What's wrong? It's been weird for a while now?"
