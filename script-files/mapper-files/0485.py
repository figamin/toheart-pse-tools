...
text_array = [
    ...
    ("「だからって…、すごいじ痰ゃないのよ」",
    ""),
    # "That's why... there's really no phlegm."
    ...
    ("「じ痰ゃあ、あんたは曹国鼾語で１００点謫取齊れるって言うのね！？」",
    ""),
    # "Ah, you say you'll get 100 points in Cao Guogang!?"
    ...
    ("日本のは入しくｍ迯られてんだよ」",
    ""),
    # Japan is a place where it enters and is a place where it goes."

    ("「なによう、冝日本の英皷語は簡単だって言いたい",
    ""),
