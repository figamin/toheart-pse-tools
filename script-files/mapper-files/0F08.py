...
text_array = [
    ...
    ("「…ハア〜ァ、予想どおりの展開ね。どうせこうなるんだったら、あかりＶＳ史とか、そんな意外な勝縁負が見たかったわ」",
    ""),
    # "...Haaaah, that's what you expect. If this were going to happen anyway, I'd like to see such unexpected wins as Akari VSi history."

    ("「氈次にひかえる、お前ＶＳ史なんてのは、意外なカードじ痰ゃねーのか」",
    ""),
    # "And you, you vs. Si history, are you a surprising card-like phlegm?"

    ("「しょうがないわね。さあ、雅史。かかってらっし痰ゃい」",
    ""),
    ...
    ("「はいは〜い、今厓日はデザートヲ心の構成を試してみたいな〜っ」",
    ""),
    # "Yes, yes, I'd like to try the composition of desserts on this day."
