...
text_array = [
    ...
    ("「目末当てのマンガは見つかったか？」",
    ""),
    # "Did you find a manga that will make you think of?"

    ("「あのねぇ。知迺らない人が聞いたら、あたしはマンガしか読んでないみたいじ痰ゃないの」",
    ""),
    ...
    ("「おい、さんざん引っ張っといてそれかよ」",
    ""),
    # "Hey, pull it a lot and that's it?"

    ("「まあまあ。その役に立たないゴミの山から、使えそうな薰情報を見つけてくるのがあたしの使命なのよ」",
    ""),
    # "Okay, it's my mission to find useful information from that useless trash pile."

    ("「蛛大層な使命だな」",
    ""),
    # "It's a big mission."

    ("「…そこであたしが見つけた薰情報は、ずばり『流星雨』諱よ」",
    ""),
    ...
    ("「その流星雨がｗ似月に見鼬れるんですって」",
    ""),
    # "That meteor rain is glaring at a similar moon."
