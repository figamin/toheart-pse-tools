...
# Source file: 029C.txt

text_array = [
    ("（芹°香	回秤数イベント	２Ｆ	ＬＶ４）閨（選択綜Ａ	も、もう薬は勘弁してくれ…）",
    ""),
    # (Seri°Kawa, Scales Event 2F LV4)Seri (Please give up on the medicine even if you are in Chosen So A...)
    ...
    ("もともとオレのこと心配してくれたんだしさ。怒っち痰ゃいねー諱よ。それより｢｢」",
    ""),
