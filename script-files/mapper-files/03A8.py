...
# Source file: 03A8.txt

text_array = [
    ("（智子	回秤数イベント	帰闍り道	ＬＶ２）閨（４月）閨（ゲーセン）",
    ""),
    # (Tomoko's Scales Event Return Road LV2) (4 Shizuki) (Arcade) 

    ("その冾日の帰闍り、なんとなく暇だったので、ぶらっとゲーセンに寄った。",
    ""),
    ...
    ("忘齧れもしないこの間、志保とрヤクドナルドのおごりを賭けてｑったゲーム气勝縁負のことだ。",
    ""),
    ...
    ("「んじ痰ゃ、約束どおり、おごってもらうわよ。えっと今厓日は、トリプルチーズのバリャーにアップルパイ、ドリンクはねぇ〜…」",
    ""),
    ...
    ("「ちっくしょ〜っ！	やい、志保、テ＜メェ！	さっきのあのプレイはマグレなんてもんじ痰ゃねーぞ！	前熨もって練習してやがったな！」",
    ""),
    ...
    ("こうなったら、氈次の戦いに備えて、オレもたっぷり練習してやるぞ。",
    ""),
    ...
    ("諱取りあえず…まずはち痰ゃんとゴールできるように頑張窒う。",
    ""),
    # I didn't know what he was saying...I tried my best to get the goal first.
    ...
    ("今厓日はこのぐらいにして、帰うか。",
    ""),
    # I'll leave it at this point for the day I'm back.
