...
text_array = [
    ...
    ("「｢｢ホント、可愛いんだからぁ。あんた、変な気起こしち痰ゃダ＜メ諠よ？」",
    ""),
    ...
    ""),
    # "...Ah, come on, why don't you take a break here? It's been my favorite lately. Here you go."

    ("そう言って志保は、河艶敷を指差した。",
    ""),
    # With that, Shiho pointed to Kawaenshiki.

    ("「ますますお前迹らしくねーな。こんな場鰹所が気に入體るなんて」",
    ""),
    ...
    ("縺後はテストさえなければ…。◯",
    ""),
    # After that, if there's no need to be a test...◯
