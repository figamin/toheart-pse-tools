...
text_array = [
    ...
    ("諱先輩のしなやかな指謗先が、艨ゆったりと優莱な手つきでカードをめくっていく。",
    ""),
    ...
    ("「なるほど。じ痰ゃ、そそ進学することを考えて、真面目に勉強を始めっかな」",
    ""),
