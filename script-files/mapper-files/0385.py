...
# Source file: 0385.txt

text_array = [
    ("（智子	回秤数イベント３	学校を出髀る	ＬＶ１）閨（選択綜Ｂの続き）†",
    ""),
    # (Tomoko's Scales Event 3: Departing from school LV1) (Continued from Chosen Soku B)†
    ...
    ("ど、どう烽説明すり痰ゃいいんだ、この状況！？†",
    ""),
    # How should I just explain it to you, this situation!?†
