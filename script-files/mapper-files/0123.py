...
text_array = [
    ...
    ("眠い目をこすりながら廊下に出髀ると、縺後撃から声をかけられた。",
    ""),
    # I came out into the hallway rubbing my sleepy eyes, and was called out to me by the attack after the attack.
    ...
    ("「、なんだか背白が丸まってるｃ」",
    ""),
    # "It's kind of curled up the back."
    ...
    ("「さっき、あかりとし痰ゃべってたネ」",
    ""),
    # "Satsuki, Akari and I had a phlegmy caterpillar."
    ...
    ""),
    # "By the way, there are some quality questions I've been wanting to hear for a while now."
