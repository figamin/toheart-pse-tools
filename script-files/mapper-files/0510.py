...
text_array = [
    ...
    ("「なにしてんだ、こんなとこで？	冝日曜坥日は道齠場の冾日なんじ痰ゃねーの？」",
    ""),
    ...
    ("「いえ、それがお店にはあまり出回ってないみたいで。だから高注文しました」",
    ""),
    # "No, it doesn't seem to be a lot of that in stores. That's why I ordered it a lot."

    ("「へえ。なんて本？」",
    ""),
    # "Whoa. What kind of book?"

    ("「最強格闘技の科学です」",
    ""),
    # "The science of the strongest martial arts"
