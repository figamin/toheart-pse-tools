...
# Source file: 08AE.txt

text_array = [
    ("（戟レミィ	回秤数イベント	１階２	ＬＶ２）閨（選択綜	遊園地）†",
    ""),
    # (Gakuremi Scales Event 1st Floor 2 LV2) (Seisho Amusement Park)†

    ("「海とか山とか烽も、楽しそうだけどよ。遊びに行くんなら、遊園地とか烽も最近は面猪白そうだぜ？」",
    ""),
    # "The sea, mountains, and hot springs look fun. If you're going to play, amusement parks and hot springs look like they're all pretty cool these days, right?"

    ("アウトドア否阡定派って墲わけじ痰ゃないけど、確実に面猪白さが保証されてる遊園地なんか烽も、候竚補から外せないと思う。",
    ""),
    # People who are not in the outdoors are not worth it, but I think it's impossible to get rid of the amusement parks where you can be guaranteed to be beautiful.

    ("それに、遊園地熬も家の外だしな。†",
    ""),
    # Also, the amusement park, Ying, is outside the house.†
    ...
    ("「そうだな。…本齧場のディザニー堰ランドには奄負けるけど」",
    ""),
    # "That's right... I'm losing to the Disney Weir Land, the main gnawing ground."
    ...
    ("…え〜と、考えてみると冾日本に有名な遊園地は一つしかないのか烽も…。",
    ""),
