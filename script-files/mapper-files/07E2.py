...
text_array = [
    ...
    ("「そうやってあきらめた感じで言ってると、なにも成功しないもんだ」",
    ""),
    ...
    ("「あ、オレは説教しにきたわけじ痰ゃねえから。あと、謝っとこうと思ってな」",
    ""),
    ...
    ("「いえ…、きっとわたしの能力ちからのせいなんです」",
    ""),
    # "No... it's probably because of my power."
    ...
    ("「超能力がなければ、さんとわたしがこうやってお話しする機級煢もなかったでしょうから…」",
    ""),
    ...
    ("つまり、琴音ち痰ゃんが超能力者だってウ純ワサがなければオレと出初うこともなかった、って意味なんだう。",
    ""),
    ...
    ("そこでもう一度、見せてもらえれば信じられるような気がしたんだ。",
    ""),
    # So I felt like I could believe it if I showed it again and got it hot.

    ("すると琴音ち痰ゃんは悲しそうな顔で言った。",
    ""),
    # Kotone Chisho-yan said with a sad look on his face.

    ("「ダ＜メです。この能力はｊ険なんですよ。",
    ""),
    # "This is Dam. This ability is tough.

    ("もし、さんがケガでもされたら…」",
    ""),
    # If you get injured and get hot..."
