...
text_array = [
    ...
    ("蛛大切なのは正確なコント鴻ロール。",
    ""),
    # What's important is precise control.
    ...
    ("だがそれ以外にも、きっとなにか速く魔走るための秘けつがあるに痰違いない。",
    ""),
    ...
    ("かといってフルス鴻ロットルで突っ桙込んで、アウトに膨逍らんでからブレーキしてたんじ痰ゃ立ち上がりが遅すぎる。",
    ""),
    ...
    ("そんな様々なテクニックがからみあって、堰初めてあの、２’０５”００というタイムが弾き出されるに痰違いない。",
    ""),
    ...
    ("それにしても、実際に取り組んでわかったが、いくら練習したとはいえ、志保のрヤツにあんなタイムが出せるなんておかしい。",
    ""),
    ...
    ("誰かにコツを教寀わったのならともかく…。",
    ""),
    # If you taught someone the tricks, you'll also be surprised...
    ...
    ("諱よっぽどこのゲームに詳しいрヤツがいて、そいつに教寀わったに痰違いない。",
    ""),
    # There's someone who is very knowledgeable about this game, and it must have been stimulating him.

    ("ダチの多い志保だけに十分ありえる話だ。",
    ""),
    # This is a very possible story, with Shiho, who has many niggas.

    ("いったいいつ始まったのかも覚えてない、志保とのゲーセン气勝縁負。",
    ""),
    # I don't remember when it started, and I don't even remember, and I'm in the middle of arcade victory with Shiho.

    ("志保のрヤツ、回を重ねるうちに、だんだん本気になってきた。",
    ""),
    ...
    ("ホント、志保はこと下迚らないことに関しては異常なパ純ワーを発揮する。",
    ""),
    ...
    ("…とはいうものの。",
    ""),
    # ...That's what a hot thing.

    ("うーむ、行き詰まった。",
    ""),
    # Hmm, I'm stuck.

    ("これ以繹上、独学じ痰ゃ進展しそうにねえな。",
    ""),
    # After this, it seems unlikely that even if you learn it yourself, it will progress.

    ("なによりもサイフのｒ身が追いつかない。",
    ""),
    # Above all, the ramblings of the wallet cannot keep up.
    ...
    ("ここはひとまず上闖手いрヤツがプレイするのを待って、そいつからテクを垂盗み取う。",
    ""),
    # For now, wait for the guy who's really good at him to stolen his technique, then stole the technique from him.

    ("そうすり痰ゃ、金も使寬わず、志保がどうしてあんなに≠早かったのかがわかるかもしんねー。",
    ""),
    # Without using any of the Kim Hwan, I can't help but understand why Shiho was so fast.
    ...
    ("その後、３０分。",
    ""),
    # After that, it took 30 minutes.

    ("外はすっかり暗くなってしまった。",
    ""),
    # It's gotten completely dark outside.

    ("オレは、ずーっとギャャラリーを続けたが、そうそう上闖手いрヤツは現鼬れなかった。",
    ""),
    ...
    ("くそっ、これじ痰ゃあ、ちっとも参考にならないぜ。",
    ""),
    # Damn it, this is phlegm, and the hot water won't be helpful at all.
    ...
    ("もう７桙時！？",
    ""),
    # Already seven frames!?

    ("＝普通の家薗だったら、すっかり夕飯梍時だぞ。",
    ""),
