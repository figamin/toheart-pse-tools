...
text_array = [
    ...
    ("廊下であかりに出初った。",
    ""),
    # I first came out in the hallway.

    ("「諱よう。足のほうはどうだ？」",
    ""),
    # "I'll give you my name. How about your feet?"

    ("「うん、もうぜんぜんへーき。ち痰ゃんのおかげだよ」",
    ""),
    # "Yeah, it's completely ridiculous. Thanks to the sputum."
    ...
    ("「人を心配させといて、なーにが嬉しいだ」",
    ""),
    # "I'm so happy to keep people worried."
