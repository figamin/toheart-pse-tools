...
text_array = [
    ...
    ("思う間煌もなく、閃光のようなジャャブ！",
    ""),
    # There was no sparkle in my mind, and it looked like a flash of light!
    ...
    ("Ｃ	遠莱距離は手を出さず、接近寀戦のみ桙応じる。閨",
    ""),
    # C: He does not touch Torai Distance, but only responds to the close battle.Relax
