...
text_array = [
    ...
    ("ふらりと現鼬れたゲーマーふうの兄ち痰ゃんがゲーム機に乗っかり、コインを鰍投涛した。",
    ""),
    ...
    ("志保熾も真っ青のこのタイムッ！",
    ""),
    # Shiho Taru is also in full blue!
    ...
    ("鞄を手にして店燗内を出たときだった。◯",
    ""),
    # It was when I left the store with my bag in hand.◯
    ...
    ("思いっきり男の顔面にブチ麻当てた。",
    ""),
    # I hit the man's face with all my might.
