...
text_array = [
    ...
    ("だが、委員長はつんと目をそらすと、",
    ""),
    # However, the chairman looked away,
    ...
    ("「なんだよ、つめてーな。いいじ痰ゃねーか、席だって隣同士なんだからさ」",
    ""),
    # "What's that? Stab me. You've got some phlegm, you're next to each other even when you're sitting there."
    ...
    ("委員長はオレを無許視し、歩き出す。",
    ""),
    # The chairman ignored me and started walking.
    ...
    ("「なあ、もし暇なんだったら、オレと…」",
    ""),
    # "Hey, if I'm bored, I'll be really busy..."
    ...
    ("「そやから、迷惑笘やって言うてるや！？",
    ""),
    # "It's a tampering, so you're saying it's a nuisance, b!?

    ("日本齧語、通じへんのか！？」",
    ""),
    # Is Japanese boliviation difficult to understand??”
    ...
    ("はは、まいったな、こり痰ゃ。",
    ""),
    # Haha, I'm exhausted, stiff phlegm.
