...
text_array = [
    ...
    ""),
    # "I'm not sure if I saw Kamigishi-san, Professor Watanabe Tsutomu called me in the staff room, and say that."
    ...
    ("まあ、委員長とは知闥り№合ってからまだ冾日燗も浅いし、たまたま席が近いってくらいの関係でしかないしな。",
    ""),
    ...
    ("「どうしたの、ぼーっとして」",
    ""),
    # "What's wrong, I'm shaking?"

    ("声のほうを振關りｌくと、あかりがいた。",
    ""),
    # When I shook my voice, Akari came.
