...
text_array = [
    ...
    ("「ね、悔しい？	悔しい？」",
    ""),
    # "Hey, are you frustrated? Are you frustrated?"
    ...
    ("もう春休みだと思うと、自然と気分がハイになってしまう。",
    ""),
    # When I think about spring break, I naturally feel high.

    ("きっと、みんなそうだったはずだ。◯",
    ""),
    # I'm sure everyone was like that.◯
