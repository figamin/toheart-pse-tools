...
text_array = [
    ...
    ("「さ、おｏ様、お車へ｢｢」",
    ""),
    # "Oh, Mr. O, go to the car ""

    ("「おい、待てよ、運ち痰ゃん！」",
    ""),
    # "Hey, wait, luck, phlegm!"
    ...
    ""),
    # "What, what?! Is that what? Is it something to send that person home the next day?!"
    ...
    ("「ほれッ、さっさとｗ鰯翌ｩ、小僧っ！」",
    ""),
    # "Look, quickly lol sardines next, boy!"
    ...
    ("Ｃ	また乗っけてくれよな。閨",
    ""),
    # C I hope you get on it again.Relax
