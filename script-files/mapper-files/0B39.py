...
# Source file: 0B39.txt

text_array = [
    ("「それじ痰ゃ、そｂそｂ始めよっか」",
    ""),
    # "That's all, let's start b, let's start b."
    ...
    ("「で烽もどう？	なかなかできない烽もんでし蛯ょ、熟繒練者からク潟リーンヒットを奪うのは」",
    ""),
    ...
    ("「そういえば、最燕初は一発ぐらい楽汪勝だとか言ってなかったっけ？」",
    ""),
    # "By the way, did Saiyan Hatsu say that it was about one hit, huangsheng?"
    ...
    ("「あら、のってこないのね」",
    ""),
    # "Oh, it's not coming in."

    ("「今厓日は無心でいこうとｌめたからな」",
    ""),
    # "I've just tried to go without thinking about it now."
    ...
    ("「で烽も、。あなた、最燕初のこｂに艪比べるとずいぶん強くなったのよ」",
    ""),
    ...
    ("相闡手がр私じ痰ゃなければ、パンチ黹一発ぐらい、とっくに魔当たってるでし蛯ょうね」†",
    ""),
    ...
    ("「だからр私燻も、最燕初は冗談半分で鰍相闡手してたけど、最近はお烽もしｂい墲わ。このまま一発熹も烽もら墲わないで逃げ切齔れるのか、自分で烽も汲結構ギ潟リギ潟リだから」",
    ""),
    ...
    ("「まあ、そんなことより、＝早く始めようぜ」",
    ""),
    # "Well, let's start earlier than that."
    ...
    ("足が止まった、チャャンス！",
    ""),
    # My legs stopped, Chaangsu!

    ("オ激レは懐に入闢り桙込んで、左フックを冾放つ！",
    ""),
    # My gangbang enters my pocket, sniffs, and fires a left hook!
    ...
    ("すかさず、綾∴香が攻め返す！",
    ""),
    # Aya∴Ka immediately attacks again!
    ...
    ("オ激レの反ｔ撃！",
    ""),
    # My violent counter-t-shot!

    ("ボディへの左フックだ！",
    ""),
    # It's a left hook to the body!
    ...
    ("綾∴香の左がそれをブ鴻ロック、すかさず右のアッパーを冾放つ！",
    ""),
    # Aya∴Ka's left is Brought to the bottom, and immediately releases the right upper!
