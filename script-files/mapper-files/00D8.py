...
text_array = [
    ...
    ("平均点は…８４点。",
    ""),
    # The average score is...84 points.

    ("おおっ、かなりの点箔数だ。",
    ""),
    # Oh, there's a lot of point foil.
    ...
    ("「ふっふっふ。驚け、８４点だ」",
    ""),
    # "Hehehe. Surprising, it's 84 points."

    ("「え〜っ、本末当！？」",
    ""),
    # "Huh, the end of the day!?"
    ...
    ("「つまんねーことすんなっての。じ痰ゃ今回は、おたがい好調ってことだな」",
    ""),
