...
# Source file: 0452.txt

text_array = [
    ("（志保	好感度イベントＸ）閨（選択綜	３竄問目	宦○	氈勝ち）閨（ＳＥ：ピンポンピンポーン）†",
    ""),
    # (Shiho's Likeability Event X) (Choice 3rd Tampaign Question: Win) (SE: Ping Pong Pong) †
    ...
    ("…＊度当度、懲闥りねーпヤツ。",
    ""),
    # ...*He's not punished at all at all.

    ("思寬わず≠吹き出しかけた。",
    ""),
    # Without thinking, I almost burst out.
    ...
    ("「はいはい、志保様のおっし痰ゃる通闥りです…」",
    ""),
    # "Yes, yes, Shiho-sama's slutty slut..."

    ("「じ痰ゃ〜ね〜」",
    ""),
    # "You're phlegmy, right?"

    ("氈勝ち逃げする格好になった志保は、縺上機刹嫌で帰っていった。",
    ""),
    ...
    ("そういえば、пヤックを忘齧れてた！◯",
    ""),
    # Come to think of it, I was forgetting about пyak!◯
