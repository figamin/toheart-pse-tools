...
text_array = [
    ...
    ("｢｢と、その前に、まずはこの空きっ腹を桙満たさないとな。†",
    ""),
    # "And before that, I have to first fill this vacant tummy.†

    ("土曜坥日で烽も、いちおう食堂ではパンがр売逕られる。",
    ""),
    ...
    ("すでにｗていた葵ち痰ゃんが、いつ烽ものように元気なあいさつをする。",
    ""),
    # Aoi Chisho-yan, who had already been laughing, gave a cheerful greeting like a hot topic.

    ("柔譓軟体操で体をほぐしている最穀だった。",
    ""),
    # It was the most grain of relaxing my body with soft exercises.

    ("それにして烽も、もう汲昼熬も過ぎたというに、おはようございますとは、これいかに。†",
    ""),
    ...
    ("葵ち痰ゃんは柔譓軟体操を続けながら言った。†",
    ""),
    # Aoi Chisho-yan said as he continued his soft and soft exercises.†

    ("袋を開けて、カツサンドにかぶりつく。",
    ""),
    # Open the bag and bite into the cutlet sandwich.
    ...
    ("「まだ？	なんだあいつ。自分から連腰絡するとか言っといて、いまだ連腰絡燉もなしかよ？」",
    ""),
    # "Not yet? What is that guy? He said he'd be having a relationship with him, but he still doesn't have a relationship with him?"
    ...
    ("「もしかして、今頃になって葵ち痰ゃんの実力にビビっちまったとかはないかな？」",
    ""),
    ...
    ("「はい。それは烽もう、とんで烽もなく強いです。",
    ""),
    # "Yes. It's so strong, without any heat.

    ("当椏時はたまたま、同じ道齠場に綾∴香さんがいたから、それほど目立ちませんでしたけど」",
    ""),
    # At the time of my visit, Aya∴Ka happened to be on the same road, so it wasn't very noticeable though."
    ...
    ("語尾に照齒れが感じられた。",
    ""),
    # I could feel the illusion at the end of the sentence.

    ("「ふうん、目標とする先輩…ね」†",
    ""),
    # "Hmm, your goal is senior... you know."
    ...
    ("綾∴香というと、あの先輩のｖ、＠栖瑞綾∴香を思い出しちまうけど、まさか同齠一人物ってことはないよな。",
    ""),
    # When I hear the word Aya∴Ka, I think of that senior, V, @Suisui Aya∴Ka, but I can't believe she's the same person.

    ("綾∴香なんて、けっこうある名前だしな。†",
    ""),
    # Aya∴Ka is a pretty name.†

    ("「蛛大痩では、だいたいいつ烽も綾∴香さんが１位、好恵さんが２位でした。そのずっと下にр私がいたんです」",
    ""),
    # "In the big skinny skin, Aya∴Ka was number one and Yoshie was number two. I was always below that."
    ...
    ("「…と、いいたいくらいですけど、正直熬もう少しはあると思います」",
    ""),
    # "I'd say that... but honestly I think there's a little more."
    ...
    ("「ほほう、そり痰ゃ鰍頼燉もしい。｢｢で、結局、氈勝つ確率はどのくらいあんのさ？」†",
    ""),
    ...
    ("葵ち痰ゃんは、轣顔を嘯伏せて言った。",
    ""),
    # Aoi Chisho-yan said, leaning down her face.

    ("「三ь割…３０パーセントか。それで烽もかなりシビアじ痰ゃないか」",
    ""),
    # "Three varieties... 30%. So, isn't it pretty severe with hot water?"

    ("「はい。そのくらいだと思います。ですけど、今回は墲わからないことが多すぎて…」†",
    ""),
    ...
    ("葵ち痰ゃんは小さくうなずいた。",
    ""),
    # Aoi Chisho-chan nodded small.

    ("だが、氈次の瞬間、その顔を繧上げると、",
    ""),
    # But the next moment, when I lifted my face up,
    ...
    ("生き生きした眩しい表﨣情。",
    ""),
    # A lively, dazzling spectacle.

    ("うんうん、それでこそ葵ち痰ゃんだぜ。†",
    ""),
    # Yes, that's what Aoi Chiffon is all about.†
    ...
    ("「諱よーしっ、今厓日燗もビシバシ行くぞ！」",
    ""),
    # "All right now, let's go to the sunkan!"
