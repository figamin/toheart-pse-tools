...
text_array = [
    ...
    ("下に降闕りて、冷蔵庫のｒのもので、適俣当な朝飯阡（昼だけど）をｍって食べた。",
    ""),
    ...
    ("まんべんなく叩いていると、そのうち額から汗がにじんできた。",
    ""),
    # As I was pounding it evenly, sweat started to swell from my forehead.

    ("縺後はこうして夕菶方まで干しておけば、太陽の≠香闕りつき布団の出女医酪ｪりだ。",
    ""),
    # After hanging, I dry it all the way to the evening slug, and it's like a female doctor who is chock-inducing to the sun.

    ("それまでは、たまっているビデオでも見ておこう。",
    ""),
