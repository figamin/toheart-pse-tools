...
text_array = [
    ...
    ("「あっ、すごい、蛛大正解です！」",
    ""),
    # "Ah, amazing, that's the right answer!"
    ...
    ("私ったら、ドジで…」",
    ""),
    # If it were me, it would be clumsy..."

    ("「なーに、いいってコト諠よ」",
    ""),
    # "What, that's fine."

    ("「せ、諱先輩って、その、なんだか、ときどき、すごく鰍頼燉もしいって思えるときがあります…」",
    ""),
    # "She, Senpai, I sometimes feel like I'm really smitten with my heart..."
