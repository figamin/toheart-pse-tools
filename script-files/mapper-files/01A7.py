...
text_array = [
    ...
    ("「…ま、待たせち痰ゃ悪いと思って」",
    ""),
    # "...Well, I thought it would be a problem if I kept you waiting."
    ...
    ("「うん、п私は信じるほうだよ。世のｒには、科学じ痰ゃ解明されていない不思議なことが、まだまだいっぱいあるはずだよ。ち痰ゃんはどう思う？」",
    ""),
    ...
    ("Ｃ	少しだけ、あるような気がしてきた。閨",
    ""),
    # C I started to feel like there was a little bit.Relax
