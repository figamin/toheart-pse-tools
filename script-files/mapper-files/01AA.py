...
text_array = [
    ...
    ("たしかに、あかりが言うように、いまだに科学じ痰ゃ解明されてないことも多いだうが、あれがそうとは限迪らない。",
    ""),
    ...
    ("「もっと確証が得逑られたら、そこで信じる」",
    ""),
    # "If you get more confirmation, I'll believe there."

    ("「…うん」",
    ""),
    # "…Yeah"

    ("「そもそも超峵常現象なんてモンの９р割以繹上は、あったほうが面猪白いっていう人間の想恆像力が生んだ空想なんだよ」",
    ""),
    ...
    ("…と、こんなこと、あかりを鰍相闡手にムキになってもしょうがないか。",
    ""),
