...
text_array = [
    ...
    ("浴風があるから、陽に魔当たり続けてなければそうで烽もないが、少しだけ夏を感じさせる。†",
    ""),
    ...
    ("「多いは多いできっと楽しいと思いますけど、ふたりっきり烽も楽しいですよね」",
    ""),
    ...
    ("「あ、あの、今度はさっきより烽も少し深めに倒して烽もらえますか？」",
    ""),
    ...
    ("格闘技鼡一色に染まってしまった一勛日だったが、葵ち痰ゃんとふたり、とて烽も充実した桙時間を過ごせたような気がした。◯",
    ""),
