...
text_array = [
    ...
    ("もし、そういう科学的なことをいっさい知迺らなかったとしたら、あの虹を見て、なんだと思った？」",
    ""),
    ...
    ("「多分、追いかけるんじ痰ゃねーか？」",
    ""),
    # "Maybe you'll have to chase it, right?"
    ...
    ("あかりがｐたまりを踏んで遊んでいる。",
    ""),
    # Akari is playing by stepping on a p-trap.
    ...
    ("Ａ	梶相変﨑わらずドジだなあ、と思った。閨",
    ""),
    # A: Kaji Ai Henzaki wasn't like he was clumsy, I thought.Relax

    ("Ｂ	安繹上がりなрヤツだなあ、と思った。閨",
    ""),
    # B I thought he was a cheap guy.Relax

    ("Ｃ	犬チックだなあ、と思った。閨",
    ""),
    # C I thought it was doggy-like.Relax
