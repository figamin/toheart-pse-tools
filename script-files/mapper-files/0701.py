...
# Source file: 0701.txt

text_array = [
    ("（琴音との出初い	イント鴻ロ	選択綜Ａ）†",
    ""),
    # (Into Koro Chosen A, first time with Kotone)†
    ...
    ("だが、全面的に信用した墲わけじ痰ゃない。",
    ""),
    # However, there is no way to completely trust him.

    ("とりあえず、％学式の魔事庶件は他に烽も証人がいるようだし、信用はできそうだ。†",
    ""),
    ...
    ("「じ痰ゃあ、体迹育館の照明燒も、その子が自分で獅落としたのかよ？」",
    ""),
    ...
    ("「それってｊないんじ痰ゃねえのか？	超能力で片っ端から物を壊すなんて」",
    ""),
    ...
    ("「さあ、どうなのかしらね。あたし烽もその辺阨りは調査穀なのよ。今厓日言いたかったのは、エスパー新嵩生と体迹育館の魔事庶件の話陂題だけ。待て続報！	って感じね」",
    ""),
    ...
    ("「うっさい墲わねぇ。あんたが余計なことまで聞き出そうとするからじ痰ゃないの」",
    ""),
    ...
    ("「なんだかんだ言って聞いてるのはあんたよ」",
    ""),
    # "You're the one who says anything and hears it."
    ...
    ("「…あ〜あ、また始まったよ。長岡との痴話迄喧嘩が」",
    ""),
    # "...Ahh, it's starting again. We've had a fight until we had a romantic affair with Nagaoka."

    ("「夫婦抹喧嘩は犬煬も食岦わぬ。",
    ""),
    # "The dogs are not even eaten when the couple fights.

    ("二年にあがって烽も変﨑わらないね」",
    ""),
    # After the second year, the hot springs won't change either."
    ...
    ("「…今厓日はこの辺にしとく？」",
    ""),
    # "...Would you like to leave it here for the day now?"

    ("「ああ。ふたりで言い№合ってて烽もしかたねえ」",
    ""),
    ...
    ("「もっと魔事前調査竝やっとけよ」",
    ""),
    # "Let's do more pre-examination investigation."
    ...
    ("「超能力だって。すごいね、ち痰ゃん」",
    ""),
    # "You're superpowers. That's amazing, sphinja."
    ...
    ("♂史まであかりと同じ顔で言う。†",
    ""),
    # Even Masochist says with the same face as Akari.†

    ("「お前まですんなり信用すんなよ」",
    ""),
    # "You don't trust me too easily."

    ("「そんなことないよ。",
    ""),
    # "That's not the case.

    ("普通の人で烽も、氏虫の知迺らせっていうのがあるし」",
    ""),
    # It's just normal people, and even the hot springs are known to be aware of the worms."

    ("「おいおい。予言の話はそれでいいけど、物が壊皷れたり動いたりすんのはどう烽説明すんだ？	氏虫が動かすのかよ？」",
    ""),
    # "Hey hey. That's fine for the prophecy, but how do you explain things like breaking down or moving? Will the worms move?"

    ("「う〜ん…。それが墲わからないから超能力なんだよ」†",
    ""),
    # "Hmm... I don't know that, so it's a supernatural power."

    ("「…お前、言うことが志保に翌似てきたな」",
    ""),
    # "...What you say looks like Shiho the next day."

    ("「そ、そう？	気をつけないと」",
    ""),
    # "Oh, right? You have to be careful."

    ("素の顔で言うｉ史。",
    ""),
    # I'm talking about my true face.

    ("轣冗談なのか本気なのか見膜当がつかない。",
    ""),
    # I can't tell if it's a joke or serious one.
    ...
    ("「超能力ってすごいと思うけど、п私は揩持ってないほうがいいな」",
    ""),
    # "I think psychic powers are amazing, but I'd rather not have one."

    ("「なんで？	あると便風じ痰ゃねえか」",
    ""),
    # "Why? If there's one, it's phlegm."

    ("ＴＶに出て儲けるとか…。†",
    ""),
    # They say they'll make money on TV...†

    ("「うん…。で烽も、＝普通じ痰ゃない人って苦労が多そうだから…」",
    ""),
    ...
    ("３人でそんな話をしているうちに、ＨＲ開始のチャャイムが鳴った。†",
    ""),
    # As the three of us were talking about this, the chime to start HR started rang.†

    ("しかし、肩糟書きが超能力者っていう新嵩生熕もおおげさな烽もんだ。",
    ""),
