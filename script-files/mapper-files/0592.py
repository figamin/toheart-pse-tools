...
# Source file: 0592.txt

text_array = [
    ("（葵	回秤数イベント５	選択繿後	Ｃ）†",
    ""),
    # (Aoi Scales Event 5 after selection C)†
    ...
    ("「あっ、そ、それより烽も、続き、続きですね！",
    ""),
    # "Ah, and more, the hot water continues, and it's a continuation!

    ("先輩、もう一度、サンドバッグを打ってください！	今度は揩拳を強く握って、閨手首を曲げずに」",
    ""),
    # Senpai, please hit the punching bag again!This time, I'll squeeze my fist tightly and don't bending my wrist."
