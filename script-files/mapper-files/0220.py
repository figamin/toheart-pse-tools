...
text_array = [
    ...
    ("だったら声かけて呼んでくれり痰ゃいいのに、梶相変﨑わらずだな。",
    ""),
    # If that's the case, you should just call me and call me, but Kaji Ai Henzaki won't.

    ("けっこう積極的なくせに、変に要領の悪いとこがある。",
    ""),
    ...
    ("「えっ？	薬が完成したって？」",
    ""),
    # "Huh? You know the medicine is finished?"
    ...
    ""),
    # "Ah, I said, I certainly said it! What? Ah, phlegm, is that finished?!"
    ...
    ("Ａ	こたえるぜ！閨",
    ""),
    # A: I'll respond!Relax

    ("Ｂ	いまは、まだこたえられない。閨",
    ""),
    # B I still can't answer.Relax
