...
# Source file: 0348.txt

text_array = [
    ("（智子	好感度イベント１回目）閨（選択綜	ＡＢＣＤからの続き）閨（選択綜	ＡＢからの続き）",
    ""),
    ...
    ("委員長…保科智子だった。",
    ""),
    # It was the chairman...Hoshina Tomoko.

    ("あまりの宸騒がしさについに立ち上がったという感じだった。",
    ""),
    ...
    ("てっきり、そう思ったのだが…。Å",
    ""),
    # That's exactly what I thought...Å

    ("「…あ、あれ？」",
    ""),
    # "...Ah, huh?"

    ("委員長は机の上の問題集とペンケースを手にすると、なにも言甯わず、すたすたと入闢り口のほうへと歩いて行った。",
    ""),
    ...
    ("一度目は無許視。",
    ""),
    # The first one was unauthorized.
    ...
    ("「わざわざ図草書室なんか行くことねーだ。それよりクラス委員長なんだから、ビシッとみんなを高注意すり痰ゃいいじ痰ゃねーか」",
    ""),
    ...
    ("諱取りあえず、間違ったことは言っち痰ゃいないはずだよな。",
    ""),
    # I'm sure there's no way I could say anything wrong without even realizing it.
    ...
    ("妙にさめてるっていうか、なんていうか。",
    ""),
    # It's strangely cold, what do you mean?

    ("とにかく愛想のねー女だな。◯",
    ""),
    # She's just an amiable bather.◯
