...
text_array = [
    ...
    ("「うん、それじ痰ゃあ、また」",
    ""),
    # "Yeah, that's a phlegm, come on again."
    ...
    ("やっぱ、わが家が一番飼落ちｒくよな〜…。",
    ""),
    # After all, my family is the one who loses their guard the most...

    ("気を抜いた瞬間、どっと疲齡れが押し寄せてきた。",
    ""),
    ...
    ("夕髣暮れ桙時。",
    ""),
    # It was a breeze at sunset.

    ("おみやげを手に、オレは学校裏の神社へとやってきた。",
    ""),
    # With my slutty slut in hand, I came to the shrine behind the school.
    ...
    ("すぐ真下にまで近づいたのに、葵ち痰ゃんは全然気がつかない。",
    ""),
    # Even though he was immediately approaching directly below, Aoi Chisho-yan had no idea.
    ...
    ("ヒザを抱えたまま、葵ち痰ゃんが言った。",
    ""),
    # Aoi Chisho-yan said, holding her knees.
    ...
    ("「＝早く帰ってこないかな…」",
    ""),
    # "I wonder if he'll come home early..."
    ...
    ("人形劇のようにぬいぐるみを操闡りながら、″闕り声で言う。",
    ""),
    # He says in a loud voice, operating the stuffed animal like a puppet show.
    ...
    ("「諱先輩じ痰ゃねーぞ、コン太だぞ！	どうだ？	しっぽがフ純ワフ純ワして可愛いだ？」",
    ""),
    ...
    ("葵ち痰ゃんが小さく声を漏逖らす。",
    ""),
    # Aoi Chisho-chan let out a soft cry.
    ...
    ("固く閉じた目に涙がにじんだ。",
    ""),
    # Tears blew through my hard closed eyes.
    ...
    ""),
    # "...That's right. It's only five days. But, but..."
    ...
    ("「…ほら、ほら、もうモかない、メかない。コン太が笑ってるぜ？」",
    ""),
    # "...Look, see, I won't cry anymore, I won't cry. Konta is laughing, isn't she?"

    ("そう言って、ぬいぐるみを葵ち痰ゃんの頬に押し魔当てた。＝",
    ""),
    ...
    ("葵ち痰ゃんの体が小さく震えていた。",
    ""),
    # Aoi Chisho-ya's body was shaking small.
    ...
    ("葵ち痰ゃんは静かに息を吐くと、",
    ""),
    # Aoi Chisho-yan exhales quietly,
    ...
    ("「オレの気搴持ちには、トーゼン気がついてたんだ",
    ""),
    # "My heartfelt spirits were aware of Tozen
    ...
    ""),
    # "I've been fond of Aoi Chisho-yan for a long time, right?"
    ...
    ("「たしかに葵ち痰ゃんって、そういうの鈍そうだからなァ」",
    ""),
    # "It's true that Aoi Chisho-ya is so dull that kind of thing."

    ("からかうように笑うと、葵ち痰ゃんは、",
    ""),
    # As I laughed teasingly, Aoi Chisho-chan was
    ...
    ""),
    # "I was planning on saying this from the beginning of my own, but I think it's too early now."

    ("「えっ…？」",
    ""),
    # "Huh...?"

    ("「ほら、これからエクストリームにｌけて、いい大変になるだ？	だから｢｢」",
    ""),
    ...
    ("葵ち痰ゃんの手を取骼ると、オレは照齒れ隠しに笑った。",
    ""),
    # I took Aoi Chisho-chan's hand and laughed at me hiding the light.

    ("そして、そのままふたりで見つめ№合った。",
    ""),
    # Then the two of them stared at each other and met.
    ...
    ("先輩に聞いて欲しいことが、いっぱい」",
    ""),
    # There are so many things I want my seniors to ask."

    ("「オッケー、とことんつき№合うぜ」",
    ""),
    # "Okay, I'll go all out and get it right."
    ...
    ("「もし先輩がいなかったら、いまごクラブはどうなってたんだうって」",
    ""),
    # "If it wasn't for my senior, what would have happened to B-banquet Love now?"
    ...
    ("「多分、続いてなかったんじ痰ゃないかって、思うんです」",
    ""),
    # "I think it probably wasn't going on with phlegm."

    ("「なんで？」",
    ""),
    # "why?"

    ("「正直に言うと、もうやめようって、何度か思いましたから」",
    ""),
    ...
    ""),
    # "Can we gather people at the heart of the day? Will this help us keep up with Aya∴Kaori?
    ...
    ""),
    # "And I was able to overcome this this time thanks to my senior Ie-senpai."
    ...
    ""),
    # "I mean, I can become Super Matsubara Aoi."
    ...
    ("オレは、衝動的にその肩を抱き寄せると、葵ち痰ゃんの頭をなでた。",
    ""),
    # I impulsively hugged her shoulder and stroked Aoi Chisho-ya's head.

    ("「諱よーし、諱よしよしよし｢｢」",
    ""),
    # "All right, a real name, a real name, a real name, a ""
    ...
    ("力を抜いて、頭を胸にあずけてきた。",
    ""),
    # I let my strength go and put my head down to my chest.
    ...
    ("そう言って、ぐいっと葵ち痰ゃんの頭を抱き寄せた。",
    ""),
    # He said that, and hugged Aoi Chi Shoyan's head.

    ("「今厓日からプラス愛のパ純ワーで頑張窒うぜ。",
    ""),
