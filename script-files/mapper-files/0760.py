...
text_array = [
    ...
    ("言ってから失敗に気づいた。",
    ""),
    # After saying that, I realized I had a mistake.

    ("これって、ただの下ネタじ痰ゃねえかっ。",
    ""),
    # This is just dirty jokes and phlegm.

    ("案の定、琴音ち痰ゃんは困ったような顔で、",
    ""),
    # As expected, Kotone Chisho-chan looked troubled,
    ...
    ("笑ってごまかすしかない。",
    ""),
    # I have no choice but to laugh and cheat.

    ("「いえ…」",
    ""),
    # "home…"

    ("素の表﨣情でそう言うと、琴音ち痰ゃんは目を嘯伏せた。",
    ""),
    ...
    ("「＃術の？	＃術の先生にまた、なんで？」",
    ""),
    # "#Anjutsu? #Why again to the technique teacher?"
    ...
    ("「え？	じ痰ゃ都∮合が悪いってこと？」",
    ""),
    # "Huh? Does that mean that phlegm is not good?"

    ("「はい…」",
    ""),
    # "yes…"

    ("「ダ＜メって言甯われると余計に気になるなぁ」",
    ""),
    # "It makes me even more concerned when the word "dam" is said to be"
