...
text_array = [
    ...
    ("誰だうかと、目を凝迢らすと｢｢それは、幼稚園くらいの小さな翌女の子だった。",
    ""),
    ...
    ("いくら子沁供葛相闡手とはいえ、それはちょっとな…、などと思ってると、",
    ""),
    ...
    ("冝日は沈みかけ、＝メグミち痰ゃんは、オレの背白で寝息を立てている。",
    ""),
    ...
    ("「アタシね、迷子の子を見つけたら、絶対に最纃後まで面倒見骭るってｌめてたの」",
    ""),
    ...
    ("結局、＝メグミち痰ゃん｢｢恵券って曹書くらしい｢｢のお母さんは見つからず、オレたちはギブアップして交番に駆け桙込んだ。",
    ""),
