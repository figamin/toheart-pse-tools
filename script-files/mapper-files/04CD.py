...
text_array = [
    ...
    ("「いよいよ今厓日で、おしまいね」",
    ""),
    # "It's finally time for the day to come, and it's over."
    ...
    ("Ａ	誰と遊びに行くんだ？閨",
    ""),
    # A Who are you going to play with?Relax

    ("Ｂ	どんなスポットを狙っているんだ？閨",
    ""),
    # B What kind of spot are you aiming for?Relax

    ("Ｃ	お前って、遊び人だよなぁ。閨",
    ""),
    # C You're a playboy.Relax
