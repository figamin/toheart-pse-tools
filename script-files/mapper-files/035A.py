...
text_array = [
    ...
    ("こうなったら『妖精の話』で無摶理﨤矢摶理訳してみるか。",
    ""),
    # If this happens, I'll try translated the story of the fairy in ``The Story of the Fairy'' without any reason.
    ...
    ("委員長は正面を見たままくすっと笑った。◯",
    ""),
    # The chairman chuckled as he looked straight ahead.◯
