...
text_array = [
    ...
    ("「沈將魚視落蝸雁閉歯月羞花」",
    ""),
    # "She sees fish fallen cochleas and goose close to the moon"
    ...
    ""),
    # "You look serious, what are you talking about? You're just like a bird."

    ("「う、うるせぇ！	お前が気搴持ちの悪いこと言うからだ」",
    ""),
