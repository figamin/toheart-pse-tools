...
text_array = [
    ("（綾∴香	冝日付イベント２）閨（４獅月１１冾日燗金曜坥日）閨（商店街）†",
    ""),
    ...
    ("てことは、もしかしたら、またこの近くに先輩がいるのか烽もしんねーな。",
    ""),
    ...
    ("しかし、あのガタイで浮黒スーツとは、なんと烽も妙な翌迫力があるぜ。†",
    ""),
