...
text_array = [
    ...
    ""),
    # "What do you summon when you summon? ...Is it lol related?"
    ...
    ("そのとき、諱先輩が『п私を信じてください』と言った。",
    ""),
    # At that time, my senior name said, "Trust me."

    ("「諱先輩を信じる？」",
    ""),
    # "Do you believe in your name senpai?"
    ...
    ("諱先輩を…信じる…か。◯",
    ""),
    # Do you believe in your senior?◯

    ("＝香の撃煙立ちこめる魔薄暗い闇のなか、召喚の儀式は始まった。",
    ""),
    ...
    ("これだけの曹舞苺台をｍ骰るんだ、準備にだって鰍相桝当な桙時間がかかったはずだ。",
    ""),
    # It must have taken a long time to prepare this much Cao Mai Strawberry Plant.
    ...
    ("Ａ	今厓日は冾日が悪いみたいだな。閨",
    ""),
    # A It seems that the day is bad on the day right now.Relax
