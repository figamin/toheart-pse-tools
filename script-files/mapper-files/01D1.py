...
text_array = [
    ...
    ""),
    # "However, I hope this cheerful final exam will be a fuss."
    ...
    ("「眠くなっち痰ゃうってこと？」",
    ""),
    # "Does that mean you're sleepy and phlegm?"
    ...
    ("あかりは手を振って、いったん家に戻った。◯",
    ""),
    # Akari waved and then returned home.◯
