...
text_array = [
    ...
    ("同じ名前で烽も、あいつの場㍼合、そういう尊敬とか憧齠れとかっていうのとは無叙縁って感じだからな。",
    ""),
    ...
    ("「それにして烽も、おたがい強くなりたいって気搴持ちは十分みたいだな」",
    ""),
    ...
    ("「だったら、ふたりと烽も、きっと今謐より強くなれるよな。なんにしたって、まずは気搴持ちが肝心だからさ。力譌より技、技諡より心の精神だぜ」",
    ""),
    ...
    ("なんだかよく墲わからないけど、諱取闔りあえずうまくまとまったな。◯",
    ""),
