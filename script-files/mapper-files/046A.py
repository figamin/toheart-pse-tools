...
text_array = [
    ...
    ("「一梭応、あるにはあるが…なんに使うんだ？」",
    ""),
    # "There are a few, but what are you using it for?"

    ("「ふふ〜ん、意外と鰍リッチね。それってさ、怐万札？」",
    ""),
    # "Hmm, it's surprisingly rich in chrysanthemum. Is that a chrysanthemum bill?"
    ...
    ("うなずくと志保は左闕手を差し出して、",
    ""),
    # Nodded, Shiho held out his left hand,
    ...
    ("ほれ、と手渡すと、志保は手にとった札を、轣顔にじ〜っと近づけた。",
    ""),
    # He handed him over, and Shiho brought the card he had picked up to his face.
    ...
    ("志保はニсヤリと笑い、",
    ""),
    # Shiho laughed slurping

    ("「いい？	５千円と１怩万円札には特別な仕掛けがあって、コピーを入しくしてんの」",
    ""),
    # "Is that okay? There's a special mechanism for the 5,000 yen and 10,000 yen bills, so you have to have a copy in it."

    ("なんて講釈を始めた。",
    ""),
    # That's what I started to give a lecture.
    ...
    ""),
    # "What is that phlegm? It's got a phlegm inside."
    ...
    ("「瘁例えば、＝普通のコピー機だと、ただの点になっち痰ゃうような細かい文囎字」",
    ""),
    ...
    ("「ほら、表に１００００って数嚼字が曹書いてあるでしょ。その下の枠のｒ謦よ」",
    ""),
    ...
    ("なるほど、やたら細かい文囎字で『ＮＩＰＰＯＮ	ＧＩＮＫＯ』って曹書いてある。",
    ""),
    # I see, in extremely detailed text, it says "NIPPON GINKO."

    ("「まさか、それがオレの札にはないっていうのか？」",
    ""),
    ...
    ""),
    # "According to my opinion, it's an elaborate counterfeit bill."
    ...
    ("そういうと、くるりと身をひるがえし、",
    ""),
    # In that case, I flinch and

    ("「ねねっ、みんな〜っ。おっかし〜んだよ〜」",
    ""),
    # "Nee, everyone. You're so funny."
    ...
    ("用意周梹到に人をおとしいれやがってぇ。",
    ""),
    # He's been trying to despise people when he reaches the hushed.

    ("知迺らない奴なら≠普通、マジン體るっての。◯",
    ""),
    # If you're not familiar with someone, you'll usually get it right.◯
