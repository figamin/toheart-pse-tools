...
text_array = [
    ...
    ("ガードを徹齠底し、綾∴香との翌距離を保った。",
    ""),
    # He kept his guard down to the bottom and kept his distance from Aya Kaori the next day.
    ...
    ("氈次の瞬間、綾∴香は一瞬で翌距離を詰め、",
    ""),
    # The next moment, Aya∴Ka is instantly closing the next distance,
    ...
    ("「すぐに薰基本姿勢に戻す。",
    ""),
    # "I'll immediately return to my basic posture.

    ("相闡手の攻ｍ撃は一発で終尞わるとは限迪らないのよ」",
    ""),
    # It's not always possible that a related attack or attack will be completed in just one shot."
    ...
    ("綾∴香は、右から、左から、正面から、様々な角度からジャャブを叩き桙込んでくる。",
    ""),
    # Aya∴Ka attacks the jayab from various angles, from right, left, and front.

    ("くっ。",
    ""),
    # Damn it.

    ("ムチのようにしなり、それでいて重い衝ｏ撃。",
    ""),
    ...
    ("Ｃ	ク鴻ロスカウンターをｌめる！閨",
    ""),
    # C: Latch the Kross Counter!Relax
