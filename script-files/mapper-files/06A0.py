...
text_array = [
    ...
    ("ふと、マルチの動力源が気になった。",
    ""),
    # Suddenly I was curious about the source of power that Makruchi had.

    ("＝普通の≠メイド鴻ロボは、たしかバッテリーで動いていたはずだ。",
    ""),
    ...
    ("「それをときどき交換してんのか？」",
    ""),
    # "Do you change that from time to time?"

    ("「いえ、充電するんです。人間のみなさんがご飯を食べるくらいの回秤数で」",
    ""),
    ...
    ("「しばらくは平気です。…えっと、たしか、補封助的に燃料電池というのがあって、ある程度は、自分ひとりで発電できるらしいです」",
    ""),
    # "I'm fine for a while.... Um, I'm sure there's a fuel cell that's a way to help protect the battery, and to a certain extent, I can generate electricity on my own."
    ...
    ("を反梍応させて、電気をｍ骰る…",
    ""),
    # Reverse the wings and squeal the electricity...
    ...
    ("「あっ、そうです、それです。燃料電池は、その逆なんです。…＄素と酸素を反梍応させると、電気とｐができるんです」",
    ""),
    ...
    ("「…あとは、お、おトイレとかで…」",
    ""),
    # "...The rest is, oh, it's a toy-dovey movie..."
