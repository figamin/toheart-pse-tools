...
text_array = [
    ...
    ("「あかり。こっち、Ｄ組の翌雛山搦理女緒ち痰ゃん。朝から夜まで働いてるタフな勤労少酪女だ」",
    ""),
    ...
    ("「蛛主婦の話じ痰ゃねーんだよ。いまはバイトをするか、しないかっていう｢｢」†",
    ""),
    ...
    ("「あ、あのっ、お話の途湯でごめんなさい。",
    ""),
    # "Ah, um, sorry for the time being.

    ("私、今厓日咩日直だから、＝早めに教室行かなき痰ゃいけないんだ。そ、それじ痰ゃあ」",
    ""),
