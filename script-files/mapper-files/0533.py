...
text_array = [
    ...
    ("梶相変﨑わらず、真武剣な表﨣情だ。",
    ""),
    # Kaji Ai Henzaki is not a real sword, but a real sword-like sentiment.
    ...
    ("「…諱よ、諱よかった。…気がついたんですね」",
    ""),
    # "...I'm a real name, I'm glad....You realised it."

    ("葵ち痰ゃんは、ほっと息を漏逖らす。",
    ""),
    # Aoi Chisho-yan let out a breath of relief.
    ...
    ("私ったら、ついカウンターをｌめち痰ゃって…」",
    ""),
    # If it were me, I would end up slurping at the counter..."
    ...
    ("…で、いまこうして倒齠れてるってことは、つまり、あっけなく一ｈ撃で沈んじまったってことか。",
    ""),
    ...
    ("「諱先輩のおかげです」",
    ""),
    # "Thanks to my senior name."

    ("「この調子なら、秋にはきっと、綾∴香といい勝縁負ができるようになるぜ。",
    ""),
    # "If this is going to happen, I'm sure I'll be able to win a good match with Aya∴Ka in autumn.
