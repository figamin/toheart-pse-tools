...
text_array = [
    ...
    ("まずはテレパシー。",
    ""),
    # First, there's a lot of repathy.
    ...
    ("氈次は透挙視。",
    ""),
    # The next one is presented to the audience.

    ("箱のｒ身とか、遠く離齬れた物笊や出女沫事が見えたりする能力。",
    ""),
    ...
    ("これは未沫芋翌\\知したりする能力。",
    ""),
    # This is the ability to know the next time you have not seen any potatoes.

    ("ノストラダムスとかが≠メジャャーだな。",
    ""),
    # Nost Banquet Radamus is something like Mejaya.

    ("あと、昔に起こったことを知ったりする能力燉も№仲間に入體るらしい。",
    ""),
    ...
    ("最纃後が念力。",
    ""),
    # Telephone power is the end of the day.
    ...
    ""),
    # Hmmm: "All these psychic abilities are expressed based on the same energy and crying...

    ("そのエネルギー源を我々はｗ魂とか魂とか呼んでいる。",
    ""),
    ...
    ""),
    # ...So, what happens when you use it to the point where it doesn't die? It seems that Uzono will gradually replenish your mental energy and crying.

    ("宇薗からっていうのがウソ臭いが、実際、宇薗には見えないけどそこにある、っていう空気みたいな謎の物質があるそうだ。",
    ""),
    ...
    ("禔練習すれば、きっと超能力をモノにできるはずだ。◯",
    ""),
    # If you practice Yu, you'll surely be able to turn your psychic powers into B-play.◯
