...
text_array = [
    ...
    ("ま、メ買う墲わけじ痰ゃないから、好きなのを選んでくれて烽もいいけど、浴女の子は≠普通自分に翌似㍽合いそうな桙服を見て烽歩く烽ものだけどな。†",
    ""),
    # Well, there's no reason to buy a melon, so you can choose what you like and it's fine for a hot girl, but normally, bathing girls are just walking around looking at fox clothes that look like they'll look like they'll be next to me.†
    ...
    ("「Ｃ盾ｏ盾ｏ撃ｌ！	、カッコイイ！」",
    ""),
    # "C Shield o Shield o Shooting! , so cool!"

    ("パチンと手をたたいて、戟レミィは微笑んだ。",
    ""),
    # Slap her hand and Karemi smiled.
    ...
    ("嬉しくない墲わけじ痰ゃないが、いい加減、誉められるのに烽も飽きてきた。†",
    ""),
    ...
    ("£替えるだけで笑迴顔が見迪られるなら、何度で烽もそうしたい気分になる。†",
    ""),
    ...
    ("「し痰ゃーねえ、閉店までだぞ」",
    ""),
    # "No phlegm, it's time for closing."

    ("「閉店まで、あと少ししかないｃ…」",
    ""),
    # "There's only a little bit left until we close..."

    ("「そうだな。少しって言って烽も４桙時間くらいあるけど…」",
    ""),
    # "That's right. I mean, I have about four frames to say a little."
    ...
    ("「あ、で烽も桙時間がないよ。行こっ」",
    ""),
    # "Ah, and the hot springs don't have time. Let's go."

    ("「お、おい、戟レミィ。この桙服脱がねえと｢｢」†",
    ""),
    # "Oh, hey, hey, Remi. I'm not taking off my fox clothes, ""†

    ("って感じで、その冾日は撃レミィとミニデートを楽しんだ。◯",
    ""),
    # That's how I enjoyed a mini date with Geki Remy.◯
