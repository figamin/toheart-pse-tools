...
text_array = [
    ...
    ("｢｢そして、пヤックの２階。",
    ""),
    # "And then, on the second floor of пYac.

    ("さっきから、あかりと志保がペチャャクチャャし痰ゃべっている。",
    ""),
    ...
    ("Ａ	家哩事が得意の子。閨",
    ""),
    # A: A child who is good at home-catching.Relax

    ("Ｂ	ざっくばらんにつき№合える子。閨",
    ""),
    # B A child who can match the number of things in a casual way.Relax
