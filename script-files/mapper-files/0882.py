...
text_array = [
    ...
    ("「だって、自分で立てなかったｃ」",
    ""),
    # "Because I couldn't make it myself."

    ("「そ、それはだな、べつの魔事諶情が…」",
    ""),
    # "Oh, that's not true, it's a different kind of magical character..."
    ...
    ("運命的っていうか、人為的な出初いじ痰ゃねーのか？",
    ""),
    # Is it fateful, or rather, artificially done, phlegm?
    ...
    ""),
    # "Ah... I was forgetting. I had something I wanted to ask."
