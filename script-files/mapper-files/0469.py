...
text_array = [
    ...
    ("「べつによこせなんて言甯わないからさ、掾持ってる？",
    ""),
    # "You're not saying that you should give it to me, so do you have any enthusiasm?
    ...
    ("Ａ	あるにはあるが…。閨",
    ""),
    # A There are, but...Relax

    ("Ｂ	掾持ってねえよ。閨",
    ""),
    # B I don't have any enthusiasm.Relax
