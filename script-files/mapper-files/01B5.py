...
# Source file: 01B5.txt

text_array = [
    ("（あかり	回秤数イベント	２Ｆ）閨（Ａ	梶相変﨑わらずドジだなあ、と思った）",
    ""),
    # (Akari Scales Event 2F) (A Kaji Ai Henzaki was so clumsy, I thought)

    ("梶相変﨑わらずドジだなあ、と思った。",
    ""),
    # I thought Kaji Ai Henzaki was clumsy, not being able to do so.
    ...
    ("「わかるよ。ち痰ゃん、п私のことドジとか言うときは、いつもそういう目するんだもん」",
    ""),
    ...
    ("「もう１６年熹ものつき№合いだからね」",
    ""),
    # "It's been 16 years since it's been a good match."
