...
text_array = [
    ("（あかり	好感度イベント６．１）閨（好感度イベント６を見た夕菶方）閨（４獅月２８冾日）閨（ＰＭ５：００ぐらい）閨（家の前の道	夕髣暮れ）閨（曲	驕夜坙日崧常）†",
    ""),
    ...
    ("£に入體ると、か墲わいいピンクのパジャャマをｒたあかりが立っていた。",
    ""),
    ...
    ("「しかし、せっかくｗたのに、なんに烽もすることねーな。…なあ、腹、減ってねーか？」",
    ""),
