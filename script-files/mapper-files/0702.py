...
# Source file: 0702.txt

text_array = [
    ("（琴音との出初い	イント鴻ロ	選択綜Ｂ）†",
    ""),
    # (Intokoro Chosen B, first time with Kotone)†

    ("現実の世のｒに超能力なんてあるはずがないんだ。†",
    ""),
    # There's no way there's anything psychic power in real life.†

    ("「ウソくせ〜っ、そんな烽もん信用できっかよ」",
    ""),
    ...
    ("「なんですって〜っ！	いるのよ！？	超能力少酪女は実在すんのよ！？	超能力が世のｒに認められる冾日は近いのよ！」†",
    ""),
    # "What! Are you there?! Doesn't a psychic power really exist?! The day when psychic powers can be recognized by the world's r's will soon be near!" †
    ...
    ("さらりと言い返した。",
    ""),
    # He responded with a lighthearted response.

    ("志保のрヤツ、轣顔を真っ赤にしてなにか言おうとしたが、急に思い出したようにうなずきはじめた。",
    ""),
    ...
    ("「アホ。誰が古い人間だ」",
    ""),
    # "Idiot. Who is the old man?"

    ("「みんなっ、こんなрヤツをのさばらしていいの？」",
    ""),
    ...
    ("「新学匇期♀早々、に技あり」",
    ""),
    # "The new school year is early, and there's a skill."
    ...
    ("「おい志保、誰熬も浮助けてくれそうにないぜ？」",
    ""),
    # "Hey Shiho, doesn't anyone think anyone will help you?"

    ("「むむむ〜っ！	いい墲わよ！	他に烽もあたしの薰情報を待ってるみんながいるんだからっ！	あんたに構ってるヒマなんてないのよ！」",
    ""),
    ...
    ("姫武琴音ち痰ゃんだっけか…？",
    ""),
    # Is Himetake Kotone-chi sphin?

    ("％学♀早々志保のネタにされるとは、とんだ災酷だよな。◯",
    ""),
    # It's really cruel to have Shiho's jokes soon after the %Gaku♀.◯
