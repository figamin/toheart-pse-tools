...
# Source file: 0B28.txt

text_array = [
    ("（綾∴香	綾∴香に挑峵戦	回秤数イベント３）閨（選択綜Ｂ	右濶手で─氛─	の続き）†",
    ""),
    ...
    ("がら空きの顔へ、すかさず、左！†",
    ""),
    # Just to the empty face, just left!†
    ...
    ("スパァンッ、スパァンッ、スパアアァーーーーーーーーーーーーーーーーーーーンッ！",
    ""),
    # Spank, spank, spank!

    ("さらに追い打ちの３連。◯",
    ""),
    # And then there's three more hits.◯
    ...
    ("その横で綾∴香がし痰ゃがんで見迪守っている。Å",
    ""),
    # Next to it, Aya∴Scent is protected by phlegm and cancer.Å

    ("「目が覚めたみたいね」",
    ""),
    # "It looks like I've woken up."
    ...
    ("「もっと烽も、そのおかげで浮助かったけど」",
    ""),
    # "It helped me to float even more than that."
