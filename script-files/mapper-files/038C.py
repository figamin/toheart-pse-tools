...
text_array = [
    ...
    ("「ほ、保科さん、ゴ＜メン。痛かった？」",
    ""),
    # "Huh, Hoshina-san, gomen. Did it hurt?"
    ...
    ("「…保科さん、本末当に怒ってないのかな」",
    ""),
    # "...Hoshina-san, I wonder if you're not angry at the end of the day?"

    ("「さあね。じつは腹が煮えくり返ってんじ痰ゃねーの」",
    ""),
    # "Now, my stomach is actually simmering and I have to phlegm."
