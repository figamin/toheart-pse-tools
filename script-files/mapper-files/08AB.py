...
text_array = [
    ...
    ""),
    # "It looks like it's a lot because it's hardened and planted."
    ...
    ("「ＳＦ？	シスコとかじ痰ゃねーのか？」",
    ""),
    # "Sci-fi? Does Cisco have phlegm?"

    ("「地元では、みんなＳＦって呼んでるｃ」",
    ""),
    # "In my hometown, everyone calls me SF"

    ("「地元だけの呼び名か…。",
    ""),
    # "Is it just a local name?
    ...
    ("「ううん。ニッポンの冬は凍えそうデス」",
    ""),
    # "Uh, it's probably freezing in Japan's winter."
    ...
    ("「ジャャパンタウンって鰍所があるの。そこにはニッポン料摎理の店とかニッポンの本屋とか、いっぱいあるｃ」",
    ""),
    ...
    ("「アハハッ、忘齧れてたｃ。",
    ""),
    # "Haha, I was forgetting.

    ("入盾ｏ窒ｒ窒ｒ凾ｙ」",
    ""),
    # "Inlet shield o nitrogen nitrogen"
    ...
    ("「ＳＦならでは、って場鰹所はないのか？」",
    ""),
    # "Is there no bonito spot that is unique to science fiction?"
