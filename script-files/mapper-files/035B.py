...
text_array = [
    ...
    ""),
    # As soon as I opened the door and went outside, the dazzling sunlight slammed my body.
    ...
    ("「諱よっ、また屋繪上で食ってたのか？」",
    ""),
    # "My name is, were you eating at the shrine again?"
