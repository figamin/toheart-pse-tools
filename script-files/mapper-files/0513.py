...
# Source file: 0513.txt

text_array = [
    ("（葵	冝日付イベント３	４月２８冾日	氏月曜	驕夜８桙時）閨（発生条緒件	葵の好感度２５以繹上）閨（自分の部屋）",
    ""),
    ...
    ("その冾日、コンビニでモ買った夕飯を食った後、オレは部屋のベッドに寝転がり、葵ち痰ゃんに借りた格闘技の本をパラパラとめくっていた。",
    ""),
    ...
    ("この先、クラブをやっていく以繹上、オレも少しは格闘技に詳しくならなき痰ゃいけないからな。",
    ""),
    ...
    ("現在の格闘技界全体の概要をわかりやすく説明したパートと、技のひとつひとつを写真とイラストでわかりやすく説明したパートだ。",
    ""),
    ...
    ("こういうのは言葉譌より、実際に葵ち痰ゃんを見ていたほうが実感できる。",
    ""),
    # This kind of thing can be felt more when you actually look at Aoi Chisho-ya than when you say it.

    ("もっと実寬戦的な攻ｍ撃のページは…と。",
    ""),
    # The page for attacks and M-shots is more like a real battle...
    ...
    ("しばらくそうして本に集薯していると。",
    ""),
    # After that, I'll collect them in a book for a while.
    ...
    ("んなわけねーか。",
    ""),
    # That's no way it's going to happen.

    ("あいつは翌風邪でダウンしてるからな。",
    ""),
    # He's gone down with the next cold.

    ("オレは読んでいた本を高枕元に置き、ベッドから起き上がった。",
    ""),
    ...
    ("階段を降闕りて玄関を見骭ると、見慣れた顔の翌女の子が立っていた。",
    ""),
    ...
    ("女の子は、ぺこっと頭を下げた。",
    ""),
    # The bathing girl bowed her head.
    ...
    ("少し赤い顔をしている。",
    ""),
    # He has a slightly red face.

    ("「どうしたんだ、こんな桙時間に」",
    ""),
    # "What's wrong, at this fox time?"

    ("「あっ、す、すみません。あの、どうしてもってお話ししたいことがあって、ですから、その…」",
    ""),
    ...
    ("「いや、そんなのはぜんぜん平気だけどさ。でも、わざわざ家にｗ磯翌ﾈんて、急ぎの話？」",
    ""),
    ...
    ("「とりあえず、縺上がんなよ」",
    ""),
    # "For now, don't let it go."

    ("「あっ、いえ、ここで結構です」",
    ""),
    # "Ah, no, I'm fine with you here."
    ...
    ("ひとり暮逡らしの男の家だ。",
    ""),
    # It's the house of a man who is so lazy.

    ("縺上がり辛いのも無摶理はないか。",
    ""),
    # Is there no way to avoid the difficulties in the swell?

    ("「じ痰ゃ、外行こうか」",
    ""),
    # "She's gotta go out, let's go out."
    ...
    ("「いきなりｗ磯翌鴦ｾもんな、びっくりしたぜ。用があんなら電話でもよかったのに」",
    ""),
    ...
    ("「すみません。できれば、雅って直接お話ししたいことだったので…」",
    ""),
    # "I'm sorry. If possible, I would have liked to talk to you directly, as a male..."
    ...
    ("返抹事はしたものの、葵ち痰ゃんはそれっきりなにも言甯わず、黙り桙込んでしまう。",
    ""),
    ...
    ("「じ痰ゃあ、言ってみな」",
    ""),
    # "You're phlegm, just say it."

    ("「…はい」",
    ""),
    # "…yes"

    ("葵ち痰ゃんは少し考えてから、′心したように顔を上げ、",
    ""),
    # Aoi Chisho-yan thought for a moment, then raised his face as if he had been in his mind.
    ...
    ""),
    # "On the day I've heard, there's something I would like to ask my senior to give me a clear answer... So that's what I did."

    ("「噤答えてもらいたいこと？」",
    ""),
    # "What do you want me to answer and get some hot?"
    ...
    ("「噤答えにくい質竡問かもしれませんけど、п私に遠慮せず、正直に、本心で嘯答えてください」",
    ""),
    ...
    ("ずいぶんと深署刻な表﨣情だ。",
    ""),
    # It's a very detailed report of the police.
    ...
    ("葵ち痰ゃんは左右に首を振った。",
    ""),
    # Aoi Chisho-yan shook his head from side to side.

    ("「だったらいいぜ。うん、噤答えるよ。正直に。",
    ""),
    # "If that's the case, it's fine. Yes, I'll answer. Be honest.
    ...
    ("葵ち痰ゃんはｌ心して言った。",
    ""),
    # Aoi Chisho-yan said with a heart.
    ...
    ("「諱先輩は、いまはまだ体験兼箔部という形で、正式にクラブの部員になってくれたわけじ痰ゃないですよね」",
    ""),
    ...
    ("「質竡問っていうのは、そのことか」",
    ""),
    # "Is that what you mean by quality questions?"

    ("「はっきりと嘯答えてほしいんです」",
    ""),
    # "I want you to give me a clear answer."

    ("言ったあと、葵ち痰ゃんの肩が小さく震えているのがわかった。",
    ""),
    ...
    ("葵ち痰ゃんは、正直に、と言った。",
    ""),
    # Aoi Chisho-yan said honestly.

    ("正直に、本心で嘯答えてほしい、と言った。",
    ""),
    # He said he wanted me to be honest and sincerely answered.

    ("どういう意図があるのかはわからないが、いい加減な気搴持ちで嘯答えてはいけないような気がした。",
    ""),
    # I don't know what the intention is, but I feel like I should not answer with a casual attitude.

    ("オレにとっても葵ち痰ゃんにとっても、重要な意味を持つ嘯答えのような気がした。",
    ""),
    # I felt that both Koto and Koto for me were important answers that had important meanings.

    ("諱よく考えた上での、はっきりとした嘯答え。",
    ""),
    # A clear answer based on a thoughtful and thoughtful answer.
    ...
    ("正直、いまはまだ遊び半分ぐらいの半端な気搴持ちでやってるのかもしれない。",
    ""),
    ...
    ("Ａ	正直、自信はない。閨",
    ""),
    # A: Honestly, I'm not confident.Relax
