...
text_array = [
    ("（葵	冝日付イベント３	４獅月２８冾日	氏月曜	驕夜８桙時）閨（発生条緒件	葵の好感度２５以繹上）閨（自分の部屋）†",
    ""),
    ...
    ("「あっ、す、すみません。あの、どうして烽もｉってお話ししたいことがあって、ですから、その…」",
    ""),
    ...
    ("どういう意図があるのかは墲わからないが、いい加減な気搴持ちで嘯答えてはいけないような気がした。",
    ""),
