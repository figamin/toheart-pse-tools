...
text_array = [
    ...
    ("ガードをかためて、体力温存。",
    ""),
    # Replenish your guard and save your energy.

    ("綾∴香が疲齡れたのを見計迪らって、反ｔ撃。",
    ""),
    # As Aya∴Ka felt exhausted, he was deemed to be fired and attacked him against him.

    ("というｍ寘戦だったのに、無摶理﨤矢摶理ガードをこじ開けられちまうとは…。",
    ""),
    ...
    ""),
    # Swaying to arouse and avoid the upper body.
    ...
    ("「そうそう、それでいいじ痰ゃない。あんまり深く考えない」",
    ""),
    # "That's right, that's not good. I don't think too deeply about it."
