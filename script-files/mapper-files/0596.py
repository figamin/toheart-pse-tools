...
text_array = [
    ...
    ("「…でも、さっき葵は、＝メンバーはまだ自分ひとりしかいないって言ってたけど…」",
    ""),
    # "... And Kao said earlier that Aoi was the only member to be still...
    ...
    ("「オレも同じクラブの人間なんだ。だから、話に関係ないわけじ痰ゃないだ？」",
    ""),
    ...
    ("「自分たちが一生恊懸命笆やってることを、遊び呼ばわりされたんじ痰ゃたまんねーしな」†",
    ""),
    ...
    ("「たしかに、このオレの練習なんて、坂下から見鼬れば、遊びみたいなモンかもしれねえ。でもな、葵ち痰ゃんは痰違うぜ。側で見ていたオレだから言える。この子の頑張闥りは正真正銘の本物だ。格闘技に打ち桙込む精神なら、多分、誰にも奄負けない！」†",
    ""),
