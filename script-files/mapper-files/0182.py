...
text_array = [
    ...
    ("あかりはにっこり嬉しそうに微笑んだ。◯",
    ""),
    # Akari smiled happily and happily.◯

    ("「いっし蛯ょに帰驪るの、久しぶりだね」",
    ""),
    # "It's been a while since I've returned to Ebi."

    ("「そうい竄や、そうだな」",
    ""),
    # "You're tampering with me, right?"

    ("朝はいつ烽もいっし蛯ょにｗ磯翌ﾓたりだが、ク宴ラスが痰違うこと烽もあって、今厓日みたいにばったり出初妺わない限闌り、いっし蛯ょに帰驪ることはほとんどない。",
    ""),
    ...
    ("ずんずん烽歩くオ激レを、あかりが小柾走闡り気味に追っかけてきた烽もんだ。",
    ""),
    # Akari chases me as I walks around in a tiny run, like a small run.

    ("いつ頃だｂう、息を切逅らせるあかりを見て、悪いなと思い始めたのは…。†",
    ""),
    ...
    ("「おっ、そうい竄や、今厓日は３冾日じ痰ゃないか。",
    ""),
    # "Oh, that's what you're saying, isn't it sputum now?

    ("ってことは、ひな祭闕りか？」",
    ""),
    # Does that mean it's a Hinamatsuri festival?”

    ("「うん、そうだよ」",
    ""),
    # "Yeah, that's right."

    ("「しかし、ひな祭闕りっての烽も、存在感のない行枕事だよな。誰かが福口にしないと気づかずに過ぎ獅去っちまう」",
    ""),
    ...
    ("「ひな祭闕りといえば｢｢」",
    ""),
    # "When you think of Hinamatsuri, you think of ""
    ...
    ("ひな祭闕りのときなんかは、諱よくオ激レたちを集めて、閨手詩闕りの料摎理を振髏る曹舞ってくれたりした烽もんだ。",
    ""),
    ...
    ("「あれってｂ高いんだｂ？	せっかくモ買って烽も、娘が蛯大きくなると用済みか。親熕も悲しいよな」",
    ""),
    ...
    ("「あ、ひな祭闕りといえばだけど｢｢」",
    ""),
    # "Ah, I'm talking about Hinamatsuri, but ""
    ...
    ("Ａ	オ激レが窒白酒飲んで撃酔っ払ったことか？閨",
    ""),
    # A: Was it that I got drunk after drinking nitrogen liquor?Relax
