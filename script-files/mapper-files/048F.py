...
# Source file: 048F.txt

text_array = [
    ("（志保	回秤数イベント	１階１）閨（選択綜	見卲放す）",
    ""),
    # (Shiho Scales Event, 1st floor 1) (Select Sou Release)

    ("今回は手緖口を変えて、見卲放したような態度に出てみることにした。",
    ""),
    ...
    ("…案の定、志保が乗ってきた。",
    ""),
    # ...As expected, Shiho has arrived.

    ("「お前はススんでるрヤツだと思ってたのに、なかなかどーして、子沁供だねぇ」",
    ""),
    # "I thought you were a good guy, but how did you think you're so absorbed in your child?"

    ("オレは、あわれみをたっぷり桙込めて言った。",
    ""),
    # I said with plenty of sluts.

    ("「なんなのよぉ！	その目！」",
    ""),
    # "What are you talking about! Those eyes!"
    ...
    ("ダッシャをかけた瞬間、オレは柔らかい壁にぶつかり、跳ね返った。",
    ""),
    ...
    ("志保がそんな声を上げる。",
    ""),
    # Shiho utters such a voice.

    ("「ハアィ！」",
    ""),
    # "Haa!"

    ("今更言うのはなんだけど、オレたちのすぐ目の前には金髪のｔ少酪女が立っていた。",
    ""),
    ...
    ("そう言って、レミィは行ってしまった。",
    ""),
    # With that said, Karemi left.

    ("「ねえ…、レミィって、近くで見骭るとホントヴ人ね。さっすがハーフ」",
    ""),
    # "Hey... If you look closely at me, you're really a V-like guy. I'm half-Japanese."

    ("「そうだな…」",
    ""),
    # "That's right..." 

    ("彼女は圧倒的に男子に人気があるのだが、お曹国柄の痰違いか実際につき№合おうとするрヤツはいない。",
    ""),
    # Her boyfriends are overwhelmingly popular with boys, but perhaps there is no one who actually tries to match her with the phlegm of the Osao-Goku.

    ("本気でつき№合いたいと思ってるなら、そんなことは関係ないと思｢｢。",
    ""),
    # If you're serious about wanting to meet your spot, then that doesn't matter.
    ...
    ("その後、オレが口からでまかせを言っていたことがバレ、志保に散々文蝠句を言甯われる羽目になってしまった…。",
    ""),
