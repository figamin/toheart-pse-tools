...
text_array = [
    ...
    ("「どうした？	なんか用か？」",
    ""),
    # "What's wrong? Is it something to do?"

    ("「うん。ねえ、今厓日はなんの冾日か知ってる？」",
    ""),
    # "Yes. Hey, do you know what day the day is now?"
    ...
    ""),
    # "What are you talking about? The day is the final day of the promised event.

    ("例の勝縁負の」",
    ""),
    # The same winning streak is negative."
