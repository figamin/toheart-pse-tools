...
text_array = [
    ...
    ("「本物？	さあ、出てみないことにはねぇ」",
    ""),
    # "The real thing? Now, I don't want to go out."

    ("「なかなか鰍頼燉もしいじ痰ゃねえか。これなら、安心してこええ映謇画煢も見鼬れるな」",
    ""),
    # "It's pretty good that you're going to have a lot of phlegm. With this, you can feel safe and enjoy the phlegm."

    ("実際、隣でキャャーキャャー言って抱きつかれるのは嬉しいが、映謇画に集薯できない意味では困骰る。",
    ""),
