...
# Source file: 0103.txt

text_array = [
    ("（あかり	冝日付イベント１．１）",
    ""),
    # (Akari Pest Date Event 1.1)

    ("（冝日付イベント１で選択綜Ａを選んだ場㍼合）",
    ""),
    ...
    ("「ち痰ゃんの部屋に入體るの、久しぶり」",
    ""),
    # "It's been a while since I've entered Chisho-chan's room."
    ...
    ""),
    # "Well, let's start right away, not just that."
    ...
    ("「ふふっ、じ痰ゃあ、さっそく始めよっか？」",
    ""),
    # "Hehe, phlegm, let's start right away?"
