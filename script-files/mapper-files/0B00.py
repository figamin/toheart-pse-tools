...
text_array = [
    ("（綾∴香	冝日付イベント１）閨（３獅月１２冾日盗曜坥日）閨（葵	芹°香のエンドを見た繧後で発生する）閨（公園）†",
    ""),
    ...
    ("まあ、ハシゴがあり痰ゃ別だけど、んな烽もん、そのへんに立てかけてある墲わき痰ゃねーし。",
    ""),
    ...
    ("…ったく、それにして烽も、猫ってрヤツは、どうしてこう馬鹿なのかね。",
    ""),
    ...
    ("言いつつ振關りｌくと、浴女の子が不安そうに顔をのぞき桙込んでいた。",
    ""),
    ...
    ("し痰ゃがみきると、彼濫女は軽竚やかにポンポンと地面に降闕りた。",
    ""),
