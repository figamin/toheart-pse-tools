...
text_array = [
    ...
    ("「琴音ち痰ゃ…姫武さん、蛛大苟丈夫か？」",
    ""),
    # "Kotone's phlegm... Himetake-san, are you sturdy and sturdy?"
    ...
    ("琴音ち痰ゃんは、何かを必死にこらえている。",
    ""),
    # Kotone Chisho-chan is desperately trying to hold back something.
    ...
    ("「なにこれ？	変な音しない？」",
    ""),
    # "What is this? Doesn't it sound like a strange sound?"
    ...
    ("これって、ウ純ワサの超能力なのか！？",
    ""),
    # Is this Ujn Wasa's supernatural power??
    ...
    ("目に涙をいっぱいためて、琴音ち痰ゃんは頭を下げた。",
    ""),
    # With tears in her eyes, Kotone Chisho-yan bowed her head.
