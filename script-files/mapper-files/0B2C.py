...
text_array = [
    ...
    ("くどいようだが、たったの一発。",
    ""),
    # It seems like it's a pain, but it's just one shot.
    ...
    ("諱よし、今厓日は薰基本に奄忠実に行くぞ。Å",
    ""),
    # Okay, I'll go to Amami's basics on this day.Å
    ...
    ("その可能性は、多分ゼ鴻ロだな。",
    ""),
    # The possibility is probably Zekoro.

    ("もう少し待とう。Å",
    ""),
    # Let's wait a little longer.Å
    ...
    ("たとえば魔事故。",
    ""),
    # For example, a magical accident.
