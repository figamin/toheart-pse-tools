...
text_array = [
    ...
    ("「うん、だから自信攝持って格闘技、続けなよ」",
    ""),
    # "Yeah, so keep on working on martial arts with confidence."

    ("「はい、ありがとうございます。そんなふうに言ってくださると、嬉しいです」",
    ""),
    # "Yes, thank you. I'd be happy if you said that."
