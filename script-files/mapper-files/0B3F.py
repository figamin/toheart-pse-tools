...
text_array = [
    ...
    ("渡闢り廊下で偶然、葵ち痰ゃんに出初った。†",
    ""),
    # By chance, I first appeared in Aoi Chisho-yan in the corridor.†
    ...
    ("「諱よう、葵ち痰ゃん」",
    ""),
    # "You'll be my name, Aoi Chishonan."
    ...
    ("「グ鴻ローブでの殴濶り№合いでさァ…」",
    ""),
    # "We're hitting the ball with a Ghoo Robe, so we're not going to meet again..."
    ...
    ("「たとえば、なんかこう、とりあえず素人が気をつけなき痰ゃいけないというポイントとかはあるかな？」",
    ""),
    # "For example, are there any point where amateurs need to be careful about phlegms?"

    ("「ポイントですか。うーん…」",
    ""),
    # "Are you the point? Hmm..."
    ...
    ("「まずこう腕をカギ型にしてですね」",
    ""),
    # "First, make your arms a key shape."

    ("「こう？」",
    ""),
    # "like this?"

    ("「はい。そして、左闕手の腕椈時計を見骭るような感じで｢｢」†",
    ""),
