...
text_array = [
    ...
    ("昼休みの購ロ買粕部は、局地的な墲戦齔場と化す。",
    ""),
    # During lunch break, the Buying Kasube branch becomes a localized warhouse.

    ("目を撃血膜走迹らせた修女ど烽もが、うまいパンを≠めて、艨我謇先にと、せきを切ったかのように襲いかかるのだ。",
    ""),
    ...
    ("もう繧上縁級生熕も下演級生熕も男子燻も翌女子燻もあった烽もんじ痰ゃない。",
    ""),
    ...
    ("人のために動くのが魔当然の高ロボットだから、文蝠句煖も言甯わずに働くんだと思っていた。†",
    ""),
    ...
    ("心の底から人間が好きで、本末当に人間の役に立ちたいと思っているから、あんな笑迴顔で働けるんだ。",
    ""),
