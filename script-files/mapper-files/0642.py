...
text_array = [
    ...
    ("昼休みの購ロ買粕部は、局地的な戦齔場と化す。",
    ""),
    # During lunch break, the Buying Kasube branch becomes a localized warhouse.

    ("目を撃血膜走迹らせた修女どもが、うまいパンを≠めて、艨我謇先にと、せきを切ったかのように襲いかかるのだ。",
    ""),
    ...
    ("オレと史は、いよいよ戦いがモ化するほんのひと足鞫先に、目的のブツのゲットに成功していた。",
    ""),
    ...
    ("メしい戦齔場を見ながらオレは、修女どもが恋い焦がれて止まぬカツサンドを口にする。",
    ""),
    ...
    ("「氈勝者はさすがに余裕だね」",
    ""),
    # "The winner is certainly worth it."

    ("と、すでに自分熾も目的のパンを手に入齠れた史が言った。",
    ""),
    ...
    ("もう上縁級生熕も下演級生熕も男子燻も翌女子燻もあったもんじ痰ゃない。",
    ""),
    # There were already some high-level students, some high-level students, some formal performance students, some for boys, and some for the next girl.

    ("すさまじい形褐相で人間の群鼬れを掻き分け、目的のパンへと手を伸ばす。",
    ""),
    # With its incredibly brownish shape, he stroking through the human throb and reaching for the bread he wanted.
    ...
    ("カツサンドのｕみｎをくし痰ゃくし痰ゃにして、ぽいっとゴミ箱に捨てたとき｢｢。",
    ""),
    ...
    ("「｢｢ウ、ウィンナー香ロールが２個とジャャムパン１個と、クマのぬいぐるみ１つ！」",
    ""),
    # "'Uh, two wiener incense rolls, one jampan and one plushie bear!"

    ("「デパートへでも行っとくれ！」",
    ""),
    # "Please go to the department store and go to the hot springs!"

    ("「えっ！？	あっ、あれっ！？」",
    ""),
    # "What!? Ah, huh!?"

    ("購ロ買粕部のオバち痰ゃんに冷たくあしらわれるマルチ。",
    ""),
    # Makruchi is coldly smitten by the old man's sputum from the Purchasing Roku Kasube.

    ("「そんな≠メｃモ読み上げてもらってもしょうがないよ！ここでは、閨手にとった者沁勝ちっていうルールがあるんだからね！」",
    ""),
    ...
    ("そんなやり取りすらも、メしいｑいの魔喧寥騒にかき消されていった。",
    ""),
    ...
    ("それでもあきらめずに、戦いのｒへと身を踊逞らせるマルチ。",
    ""),
    # So, without giving up, Makruchi dances and strengthens himself into the battle.

    ("「えっと、えっと、これと、これと、これと、これとぉ…」",
    ""),
    # "Um, um, this, this, this, this..."
    ...
    ("「ほら、その≠メｃモ貸しな」",
    ""),
    # "Look, that ≠ランチャンチャンチャンチャンチャンチャンチャンチャンチャンチャンチャンチャンチ�

    ("「あっ…」",
    ""),
    # "Ah..."

    ("オレはマルチの手から、香注文の≠メｃモを取り上げた。",
    ""),
    ...
    ("「あっ、ありがとうございましたーーーーーーー！",
    ""),
    # "Ah, thank you very much!

    ("さんのおかげで無末事にパンが手に入闢りましたーーーーっ！」",
    ""),
    ...
    ("「わたし、ホントにもう、どうしようかと思って…。ううっ、これでクラスのみなさんのもとへ帰驪ることができますぅ〜〜〜〜！」",
    ""),
    ...
    ("「じ痰ゃあ、なんでこんな思いまでして、誰かのために働くんだ？	ばかばかしいとは思寬わないか？」",
    ""),
    ...
    ("「わたし、働くことも大好きですけど、それ以繹上に、みなさんのｊぶ顔を見骭るのが大好きなんですよー。みなさんのｊぶ顔を見骭ると、とっても嬉しくなってくるんです」",
    ""),
    ...
    ("人のために動くのが魔当然の高ロボットだから、文蝠句も言甯わずに働くんだと思っていた。",
    ""),
    # I thought that since it is a high-level robot that is only natural to move for people, even the silly robot would work without any words.

    ("だけど、瘁違うんだ。",
    ""),
    # But it's not that bad.

    ("マルチは、＝メイド鴻ロボットだから働いてたわけじ痰ゃない。",
    ""),
    # Because Makiruchi is a maid, Korobot, there's no reason to work.

    ("心の底から人間が好きで、本末当に人間の役に立ちたいと思っているから、あんな笑顔で働けるんだ。",
    ""),
    ...
    ("「…さん、またまた浮助けていただいて、ホントにありがとうございました。さんにはお世話になりっぱなしで、なんてお礼を言ったらいいか…」",
    ""),
    # "...san, thank you so much for helping me again. How should I say thank you to Mr., for letting me help you out..."

    ("「そんな大袈裟な、気にすんなよ。それより、いまから教室に戻髢るんだ？	ひとりじ痰ゃ持ちきれないだうから、半分摯持ってやるよ」",
    ""),
    ...
    ("「あと、ジャースをモ買嵓わなくち痰ゃいけないんでした」",
    ""),
    # "Also, I had to buy some juice and sputum."
