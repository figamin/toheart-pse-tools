...
text_array = [
    ...
    ""),
    # Suddenly, a light so intense it couldn't even be opened was blowing.
    ...
    ("「まぶしくて見えなかったよ」",
    ""),
    # "It was so dazzling I couldn't see."
    ...
    ("「ねえアタシ、氏月に帰ったの？」",
    ""),
    # "Hey, did I come back to Mr. Moon?"
    ...
    ("「夢の話はこれで終尞わりだ」",
    ""),
    # "This is the end of the dream story."
