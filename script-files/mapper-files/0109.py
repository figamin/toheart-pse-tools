...
text_array = [
    ...
    ("浴風が≠吹くと、まるで≠吹瘰雪のように花びらが降闕り高注いだ。†",
    ""),
    ...
    ("一梭時はｒ止しようかと烽も思ったが、あかりがせっかく弁抹当まで用意したっていうので、結局ふたりだけで烽もｗ磯翌ｱとにした。†",
    ""),
    ...
    ("だが、いつ烽もの馬鹿寰騒ぎとはまた痰違って、なんていうか、こういう獅落ちｒいた花見っての烽も悪い烽もんじ痰ゃないな。†",
    ""),
    ...
    ("その繧後、艨ゆっくりとふたりで公園を烽歩いてから、ベンチに座闕り、あかりの手詩闕り弁抹当を食べた。",
    ""),
