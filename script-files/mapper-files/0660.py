...
text_array = [
    ...
    ("なんだかよく墲わからないが、閨手渡されたのは透明の袋に入ったお守闔りだった。†",
    ""),
    # I don't really understand the situation, but what I was handed over was a charm in a transparent bag.†

    ("「なんだこり痰ゃ。お守闔り？」",
    ""),
    # "What's the hard phlegm? Are you asking for your talisman?"
    ...
    ("「＊恂除けのお守闔りだから、ケガなんかの災酷から守ってくれるんじ痰ゃない？」†",
    ""),
    ...
    ("「あかりち痰ゃんには烽もうあげたよ。志保に烽もさっき」",
    ""),
    # "I already gave you some hot pot to Akarichi Sphin-chan. Shiho and hot pot were already here."

    ("「なんだ。しっかり撃レディファーストかよ」",
    ""),
    # "What? Is it a solid shot lady first?"

    ("「そういう墲わけじ痰ゃないけど…」†",
    ""),
    # "There's no way I can make that kind of phlegm..."
