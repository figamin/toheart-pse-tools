...
# Source file: 08AC.txt

text_array = [
    ("（レミィ	回秤数イベント	１階２	ＬＶ２）閨（選択綜	海）",
    ""),
    # (Game Remy Scale Event 1st Floor 2 LV2) (Selection Sokai)
    ...
    ("「そんな雰囲気だけで、楽しいことが起こりそうな気がしてくるんだよ。…だから、オレは断然『海』、しかも、夏の海が好きだな」",
    ""),
    ...
    ("…なんか、梶抽象的なイ＜メージだけの理由になってしまった。",
    ""),
    # ...It's become a reason for this to be just an abstract image.

    ("「アタシ、海の近くで生まれたから、海のこと、特別に考えたりしなかったケド、…の気搴持ちを聞いて、アタシも夏の海、特別に思えるようになってきた盾ワ」",
    ""),
    ...
    ("「エヘヘへ。でも、ホントだｃ」",
    ""),
    # "Hehehe. And the hot one is true too."

    ("はにかんだ笑みで、レミィが言った。",
    ""),
    # With a shy smile, Karemy said.
    ...
    ("不意に立ち止まって、レミィが呼んだ。",
    ""),
    # Suddenly he stopped, and called out to him.
    ...
    ("「まだ春だってのに、ずいぶん気の≠早い話じ痰ゃねえか」",
    ""),
    # "Even though it's still spring, it's quite a bit of a sputum, so it's pretty quick to say."
    ...
    ("「ただし、ふたりっきりじ痰ゃなくて、学校の連中熬も何人か誘って、だぞ？」",
    ""),
