...
text_array = [
    ...
    ("近くの公衆電話から、綾∴香を呼び出す。",
    ""),
    # He calls Aya∴Ka from a nearby public phone.

    ("綾∴香の携帯の番剥は…と。",
    ""),
    # Aya∴Ka's phone number is peeled off...
    ...
    ("一発又当てれば、それでいい。",
    ""),
    # If you hit it again, that's fine.
    ...
    ("まず、長咊期孖戦は不風だ。",
    ""),
    # First of all, the Chang-Kei War was unwind.

    ("長引けば、それだけテクニックの差が出てしまうからな。",
    ""),
