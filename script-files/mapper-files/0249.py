...
text_array = [
    ...
    ("氏去年の暮れ、ここから電車で４駅ほど先の場鰹所に、ＡＱＵＡアクア−ＢＬＵＥブルーという大型の屋煢内プールがオープンした。",
    ""),
    ...
    ("まだ行ったことはないが、話を聞く限り、なかなかゴージャャスでいい感じらしい。",
    ""),
