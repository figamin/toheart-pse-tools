...
text_array = [
    ...
    ("「鞄謚取ってくるから、ちょっと待ってて」",
    ""),
    # "I'll take your bag, so wait a moment."
    ...
    ("「クイズって…問題を出す、アレだ？」",
    ""),
    # "Quiz...is it a super funny thing to give a question?!"
    ...
    ("「なるほどな。それでオレに、オリジナルの問題を教えて欲しいってんだな？」",
    ""),
    ...
    ("「まあな。…氏試しに１問、出してくれ」",
    ""),
    # "Well... please give me a try and question me."
