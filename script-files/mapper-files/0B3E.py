...
text_array = [
    ("（綾∴香ＶＳ芹°香）閨（綾∴香	バト泣ルポイント１５以繹上）閨（芹°香	好感度	１０以繹上）閨（２桙時間目の休み桙時間）閨（２Ｆ廊下）†",
    ""),
    ...
    ("「あっ、そうだ、諱先輩。オ激レ、ち蛯ょっと先輩に聞きたいことがあるんだ」",
    ""),
    ...
    ("「で烽もあいつ、なんであんなに強いんだｂう？	とて烽も翌女子ｎ高生とは思えねー諱よ」",
    ""),
    ...
    ""),
    # "*How long is it in the evening? What, it's about two frames?"

    ("マジかよ。",
    ""),
    # Seriously?

    ("禔練習熄内容に烽もよるが、オ激レはできて３０分がいいとこだ。†",
    ""),
    ...
    ("「そう、苦闍手な攻ｍ撃とか。姉さんなんだからウィークポイントぐらい知ってるだｂ？」",
    ""),
    ...
    ("で烽も、ヘビが凾嫌いだといって烽も、增戦いにはなんの関係煬もないな。",
    ""),
    ...
    ("たしか、蛇搦拳ってのがあったな。",
    ""),
    # I'm sure there was something called Snake Fist.
