...
text_array = [
    ...
    ""),
    # As we were wandering around talking, a sign of a yacht suddenly appeared on a roaring line.
    ...
    ""),
    # "Ah, I'm getting hungry... Kotone-chisou-chan, can you come over?"
    ...
    ("「あと…、じ痰ゃがバターパイと｢｢」",
    ""),
    # "And... the sputum is a butter pie and ""
    ...
    ("ひとくち食べて、琴音ち痰ゃんが言う。",
    ""),
    # Take a bite and Kotone Chisho-yan says.

    ("「なあ、じ痰ゃがバターが好きってのは北海道生まれだからなのか？」",
    ""),
