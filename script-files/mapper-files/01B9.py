...
text_array = [
    ...
    ""),
    # "First, I'll give you a question about this. What kind of occupation do you want to work on?"
    ...
    ("「ぺ、北椁京ダック！	…かな？」",
    ""),
    # "Pe, Kita-Kaikyo Duck! ...Is that the...?"
    ...
    ("「診断拠結果が出ました」",
    ""),
    # "The diagnosis results have been released."
