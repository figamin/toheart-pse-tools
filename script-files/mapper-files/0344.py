...
text_array = [
    ("（智子	好感度イベント１回目）閨（選択綜Ｄ	竅やっぱり根性出して、自分で竄やる。†",
    ""),
    ...
    ("学生梵時緕代の苦労はモ買ってで烽もしｂ。",
    ""),
    # Students' struggles at Santoku Sada are a must-have for a student.

    ("瘁若い頃から甘い汁を吸ってち痰ゃいかん。",
    ""),
    # I've been sucking up sweet juices since I was young and I can't sputum.

    ("苦は楽の墲種、未沫の自分への鰍投蒼資だと思え。",
    ""),
    ...
    ""),
    # However, it wasn't so sweet that I could just relax with all my energy.

    ("教科痩書を参考にして、パズ泣ルのように少しずつ竄問阮題を解いていく。",
    ""),
    # Using the textbook for slimming, I gradually solve the questioning questions, like a puzzle cry.

    ("なんとか一竏問ずつ終尞わらせて、諱取闔りあえず最纃後まで竄やった。",
    ""),
    # I managed to finish each question at a time, and then I ended up tampering with him until the very end.

    ("だが鰍所詮、諱取闔りあえず、の撃レベ泣ルだ。",
    ""),
    # However, after all, he couldn't get a name for himself, so he was crying out of his level of tears.

    ("多分、い竄や間瘧違いなく、噤答えはボ鴻ロボ鴻ロだ。†",
    ""),
    ...
    ("いま、あかりのрヤツがこっちを見てたぞ。",
    ""),
    # Akari's guy was looking over me right now.

    ("終尞わって一息ついたオ激レを見て、微笑んで竄やがった。",
    ""),
