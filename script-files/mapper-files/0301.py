...
text_array = [
    ...
    ("半分だけ本棚から引き抜いて聞く。",
    ""),
    # Pull only half of it out of the bookshelf and listen.

    ("すると翌女生徒は、少し考えてから、",
    ""),
    # Then the next female student thought for a moment,
    ...
    ("「あれ？	いまの、蛛大繿阪弁か？」",
    ""),
    # "Huh? Is it the current Dairyu-Human dialect?"
    ...
    ("「…ここにいたって、保科ほしなさんのこと？」",
    ""),
    # "...Are you talking about Hoshina Hoshina here?"
    ...
    ""),
    # "Hoshina-san is so intelligent, and the other day he was at the top of his grade level."
