...
text_array = [
    ("（戟レミィ	回秤数イベント	１階３	ＬＶ２）閨（選択綜	「＝メイド鴻ロボが欲しいぜ」）†",
    ""),
    ...
    ("「おめー、それって詐欺じ痰ゃねーのか」",
    ""),
    # "Hello, isn't that a scam?

    ("「ゴ＜メンゴ＜メン。…とにかく、のお手伝いがしたかったの」",
    ""),
