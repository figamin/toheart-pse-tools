...
text_array = [
    ...
    ("ふかふか気搴持ちがいい。",
    ""),
    # It's soft and fluffy and good for you.
    ...
    ("諱先輩は、申し訳なさそうな顔でうなずいた。",
    ""),
    # Senpai nodded with an apologetic look on his face.
    ...
    ("Ａ	も、もう薬は勘弁して…。閨",
    ""),
    # A, please give up on the medicine...Relax

    ("Ｂ	氈次に冾期待してるぜ。閨",
    ""),
    # B I'm looking forward to it next.Relax
