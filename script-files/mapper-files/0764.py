...
text_array = [
    ...
    ("「…ここでやってみます」",
    ""),
    # "...I'll try tampering here."

    ("琴音ち痰ゃんは、オレをベンチのとこへ連齪れてきた。",
    ""),
    ...
    ("琴音ち痰ゃんの言葉で、オレは今までの出女沫事が超能力で起こされたことを知った。",
    ""),
    # With Kotone Chisho-yan's words, I learned that the previous female droplets had been woken up by psychic powers.
    ...
    ""),
    # Kotone Chisho-chan is silent, so I looked over at that Fukukata and his face turned red and he was on the verge of defeating him.
    ...
    ("「なに言ってんだよ琴音ち痰ゃん。それより、ベンチで横になったほうがいいだ？」",
    ""),
    ...
    ("「…蛛大苟丈夫です。このままで…」",
    ""),
    # "...I'm strong. I'll stay like this..."
