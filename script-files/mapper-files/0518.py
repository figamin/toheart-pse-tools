...
text_array = [
    ...
    ("諱よし、ここはあれでいくか。",
    ""),
    # Okay, shall we go with that here?

    ("「葵ち痰ゃん、閨手に人って嘯字を曹書いて、それを飲むんだ」",
    ""),
    # "Aoi Chisho-yan, people write a letter on the collar and drink it."
    ...
    ("葵ち痰ゃんはうなずくと、閨手のひらに『人』と曹書いて、ゴクッと飲みこんだ。",
    ""),
