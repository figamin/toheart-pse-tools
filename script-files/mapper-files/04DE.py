...
# Source file: 04DE.txt

text_array = [
    ("（志保	追加イベント５）",
    ""),
    # (Shiho Additional Event 5)
    ...
    ("＝香闕りを楽しんだあとは、がぶっと一箞口。",
    ""),
    # =After enjoying the incense, I sniffed it.
    ...
    ("「おい志保、なに笑ってんだよ」",
    ""),
    # "Hey Shiho, what are you laughing?"

    ("「いいからいいから。あたしに構寘わず続けて」",
    ""),
    ...
    ("「…あかり、なんかこいつ変じ痰ゃねえか？」",
    ""),
    # "...Akari, is this guy transformed into something phlegm?"
