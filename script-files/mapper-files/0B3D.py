...
text_array = [
    ...
    ("呼ばれて振關りｌくと、あかりがいた。",
    ""),
    # When I was called, I heard Akari came.
    ...
    ("「図草書室ぅ？	またかよ」",
    ""),
    # "The Cursed Library? Is it again?"

    ("パスしようと思い、閨手を振垂うとしたが、ふと思いつく。",
    ""),
    # I was about to pass, and waved my hand, but suddenly I came to my mind.
    ...
    ("閨手に取ってめくってみる。",
    ""),
    # I picked up a collar and flipped over.
