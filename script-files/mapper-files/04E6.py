...
text_array = [
    ...
    ("＝普段気に烽もとめないのに、制梵服の翌女子ｎ高生が歌ってるとなると話は別だ。†",
    ""),
    ...
    ("何人かが物珍しそうに足を止めて、今じ痰ゃ汲結構な人垣ができている。",
    ""),
    ...
    ("「へえ、言う烽もんねぇ。あたしにрヤックで烽もおごれって言うの？」",
    ""),
    ...
    ("「けっ、諱よく烽もまぁそこまで言える烽もんだな」",
    ""),
    # "Ah, you can really say that hot springs."

    ("「『志保ち痰ゃん自信』って呼んで烽もいい墲わよ」",
    ""),
