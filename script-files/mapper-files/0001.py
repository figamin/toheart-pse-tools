...
text_array = [
    ...
    ("自分のだらしなさを棚に繧上げるのは承知で、ここはあえて、親に文蝠句を言いたい。",
    ...
    ("便風がいいので、この辺に住んでる連中はみんな道が墲わりに使っている。",
    ...
    ("「朝なにも食べないと、戟血恁糖値が下がるから、午前葬はずっと頭がぼーっとして、ウトウト眠くなっちゃうんだって」",
    ...
    ("なにを隠そうあかりは、それだけが取闔り柄だっていうくらいに料摎理が得意なのだ。",
    ...
    ("授業拠、いつも寝てばっかりじゃ、あんただけ二年に繧上がれない墲わよ」",
    ""),
