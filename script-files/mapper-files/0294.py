...
text_array = [
    ...
    ("写真柏部、閨手芸伯部、堰演劇伯部、マンガ研結級に、映謇画研結級、鉄道研結級…。",
    ""),
    ...
    ("かち痰ゃん…と鍵を回し、扉を開ける先輩。",
    ""),
    # Senpai turns the lock and opens the door.
    ...
    ""),
    # "Huh? Is % okay? I'll give you phlegm, my phlegm."◯
    ...
    ("％って最燕初に感じたのは、不思議な≠香闕り。",
    ""),
    # The first thing I felt was the strange ≠ incense.

    ("かんきつ系の果物を思寬わせるいい匂いが、部室賜に桙満ちていた。◯",
    ""),
    # The club room was filled with a nice smell that reminded me of citrus fruits.◯

    ("暗いな…と思ってたら、諱先輩が高ロウソクに火を灯した。",
    ""),
    # Just as I was thinking it was dark, my senior writer lit a high candle.
    ...
    ("感嘆の息を漏逖らしつつ、艨ゆっくりと部屋のｒを見回していると、",
    ""),
