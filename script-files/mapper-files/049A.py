...
text_array = [
    ...
    ("「そー諱よ。あんたのセンスに賭けてみることにしたのよ」",
    ""),
    # "That's it. I decided to take a bet on your senses."
    ...
    ("「そうしたいのはрヤマсヤマだけどぉ…。",
    ""),
    # "The one who wants to do that is рYamaсyama, though...

    ("結局あんたが一番気軽に話せるのよ」",
    ""),
    # In the end, you're the one who's the most easy to talk about."
    ...
    ("′こうを指差した、志保の表﨣情が変﨑わる。",
    ""),
    # ' Pointing to this point, Shiho's surface feelings change.
